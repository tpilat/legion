...
public static class Logger
{
	...
	public static global::Serilog.ILogger? SerilogLogger { get; internal set; }
	...
	private static Microsoft.Extensions.Logging.ILoggerFactory CreateLoggerFactory()
	{
		if (MicrosoftLoggingBuilder == null)
			throw new InvalidOperationException($"{nameof(MicrosoftLoggingBuilder)} is not set. Use services.AddLegionLogger extension first.");
