...
namespace Legion.EntityFrameworkCore.QueryCache;
...
public static class GlobalQueryCacheManager
{
	...
	static GlobalQueryCacheManager()
	{
		...
		CachePrefix = "Legion.EntityFrameworkCore.QueryCache.GlobalQueryCacheManager;";
		CacheTypePostfix = "_Legion_GlobalQueryCacheManager_CacheType";
