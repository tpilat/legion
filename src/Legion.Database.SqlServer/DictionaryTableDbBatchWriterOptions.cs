...
public class DictionaryTableDbBatchWriterOptions : DictionaryTableOptions, IDbBatchWriterOptions, IDictionaryTableOptions, IBatchWriterOptions
{
	...
	public DictionaryTableDbBatchWriterOptions()
	{
	}
