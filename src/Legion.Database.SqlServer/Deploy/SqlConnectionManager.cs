...
public class SqlConnectionManager : IDisposable
{
	...
	private readonly Dictionary<string, SqlConnection> _conncetionsWithoutTransaction;
	private readonly Dictionary<string, SqlConnection> _conncetionsWithTransaction;
	private readonly Dictionary<string, SqlTransaction> _globalTransactions;
	...
	public (SqlConnection SqlConnection, SqlTransaction? SqlTransaction) GetOrOpenConncection(string database, DbDeploySettings.TransactionMode? transactionMode)
	{
		...
		var connectionStringBuilder =
			new SqlConnectionStringBuilder(_dbDeploySettings.ConncetionString)
			{
