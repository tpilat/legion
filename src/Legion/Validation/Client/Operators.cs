...
public static class OperatorConverter
{
	private static readonly Lazy<Dictionary<Operators, string>> _operators = new(() => new()
	{
		...
		{ Client.Operators.DefaultOrWhiteSpace, nameof(Client.Operators.DefaultOrWhiteSpace) },
		{ Client.Operators.NotDefaultOrWhiteSpace, nameof(Client.Operators.NotDefaultOrWhiteSpace) },
	});
