...
namespace Legion.Validation.Client;
...
public class ClientCondition<T> : IClientConditionDefinition
{
	...
	public bool Execute(T? obj)
	{
		...
		return Operator.Value switch
		{
			...
			Operators.DefaultOrEmpty => ValidationHelper.IsDefaultOrEmpty(propertyValue, valueToCompare, false),
			Operators.NotDefaultOrEmpty => !ValidationHelper.IsDefaultOrEmpty(propertyValue, valueToCompare, false),
			Operators.DefaultOrWhiteSpace => ValidationHelper.IsDefaultOrEmpty(propertyValue, valueToCompare, true),
			Operators.NotDefaultOrWhiteSpace => !ValidationHelper.IsDefaultOrEmpty(propertyValue, valueToCompare, true),
