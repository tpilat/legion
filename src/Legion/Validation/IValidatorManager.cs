...
public interface IValidatorManager
{
	...
	IValidatorDescriptor? GetValidatorDescriptorFor(Type objectType, Type commandType, IServiceProvider serviceProvider, IScopeContext scopeContext, object? state = null);
}
