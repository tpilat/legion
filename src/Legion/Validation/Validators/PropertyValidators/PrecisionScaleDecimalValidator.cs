...
public class PrecisionScaleDecimalValidator
{
...
{
	protected override string DefaultValidationMessage => PrecisionScaleDecimalValidator.DEFAULT_ValidationMessage;
