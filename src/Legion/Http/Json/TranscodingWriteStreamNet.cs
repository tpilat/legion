...
internal sealed class TranscodingWriteStreamNet : Stream
{
	...
	public TranscodingWriteStreamNet(Stream stream, Encoding targetEncoding)
	{
		_stream = stream;
		...
		_decoder = GlobalCache.UTF8NoBOM.GetDecoder(); // Encoding.UTF8.GetDecoder();
