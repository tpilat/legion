...
public sealed class PolicyBuilder
{
	...
	/// <param name="retryCount">The retry count.</param>
	/// <returns>The policy instance.</returns>
	public AsyncRetryPolicy AsyncRetry(int retryCount)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	public AsyncRetryPolicy AsyncRetry(int retryCount, Func<Exception?, int, Task> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// <exception cref="ArgumentOutOfRangeException">retryCount;Value must be greater than zero.</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy AsyncRetry(int retryCount, Func<Exception?, int, Task<RetryResult?>> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// </summary>
	/// <returns>The policy instance.</returns>
	public AsyncRetryPolicy AsyncRetryUntilSucceeds()
	{
		return new AsyncRetryPolicy(
			this,
			(ex, timespan, i) => Task.FromResult<RetryResult?>(null));
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy AsyncRetryUntilSucceeds(Func<Exception?, int, Task> onRetryAsync)
	{
		if (onRetryAsync == null)
			throw new ArgumentNullException(nameof(onRetryAsync));
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy AsyncRetryUntilSucceeds(Func<Exception?, int, Task<RetryResult?>> onRetryAsync)
	{
		if (onRetryAsync == null)
			throw new ArgumentNullException(nameof(onRetryAsync));
	...
	/// <exception cref="ArgumentOutOfRangeException">retryCount;Value must be greater than or equal to zero.</exception>
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	public AsyncRetryPolicy AsyncWaitAndRetry(int retryCount, Func<int, Exception?, TimeSpan> sleepDurationProvider)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy AsyncWaitAndRetry(int retryCount, Func<int, Exception?, TimeSpan> sleepDurationProvider, Func<Exception?, TimeSpan, int, Task> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy AsyncWaitAndRetry(int retryCount, Func<int, Exception?, TimeSpan> sleepDurationProvider, Func<Exception?, TimeSpan, int, Task<RetryResult?>> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	public AsyncRetryPolicy AsyncWaitAndRetry(IEnumerable<TimeSpan> sleepDurations)
	{
		if (sleepDurations == null)
			throw new ArgumentNullException(nameof(sleepDurations));
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy AsyncWaitAndRetry(IEnumerable<TimeSpan> sleepDurations, Func<Exception?, TimeSpan, int, Task> onRetryAsync)
	{
		if (sleepDurations == null)
			throw new ArgumentNullException(nameof(sleepDurations));
		if (onRetryAsync == null)
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy AsyncWaitAndRetry(IEnumerable<TimeSpan> sleepDurations, Func<Exception?, TimeSpan, int, Task<RetryResult?>> onRetryAsync)
	{
		if (sleepDurations == null)
			throw new ArgumentNullException(nameof(sleepDurations));
		if (onRetryAsync == null)
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	public AsyncRetryPolicy AsyncWaitAndRetryUntilSucceeds(Func<int, Exception?, TimeSpan> sleepDurationProvider)
	{
		if (sleepDurationProvider == null)
			throw new ArgumentNullException(nameof(sleepDurationProvider));
	...
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy AsyncWaitAndRetryUntilSucceeds(Func<int, Exception?, TimeSpan> sleepDurationProvider, Func<Exception?, int, TimeSpan, Task> onRetryAsync)
	{
		if (sleepDurationProvider == null)
			throw new ArgumentNullException(nameof(sleepDurationProvider));
	...
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy AsyncWaitAndRetryUntilSucceeds(Func<int, Exception?, TimeSpan> sleepDurationProvider, Func<Exception?, int, TimeSpan, Task<RetryResult?>> onRetryAsync)
	{
		if (sleepDurationProvider == null)
			throw new ArgumentNullException(nameof(sleepDurationProvider));
	...
	/// <returns>The policy instance.</returns>
	public AsyncFallbackPolicy AsyncFallback(Func<Exception?, CancellationToken, Task> fallbackAction, Func<Exception?, Task> onFallbackAsync)
	{
		if (fallbackAction == null)
			throw new ArgumentNullException(nameof(fallbackAction));
...
public class PolicyBuilder<TResult>
{
	...
	/// <param name="retryCount">The retry count.</param>
	/// <returns>The policy instance.</returns>
	public AsyncRetryPolicy<TResult> AsyncRetry(int retryCount)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// <exception cref="ArgumentOutOfRangeException">retryCount;Value must be greater than zero.</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy<TResult> AsyncRetry(int retryCount, Func<DelegateResult<TResult>, int, Task> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// <exception cref="ArgumentOutOfRangeException">retryCount;Value must be greater than zero.</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy<TResult> AsyncRetry(int retryCount, Func<DelegateResult<TResult>, int, Task<RetryResult?>> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// </summary>
	/// <returns>The policy instance.</returns>
	public AsyncRetryPolicy<TResult> AsyncRetryUntilSucceeds()
	{
		return new AsyncRetryPolicy<TResult>(
			this,
			(result, timespan, i) => Task.FromResult<RetryResult?>(null));
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy<TResult> AsyncRetryUntilSucceeds(Func<DelegateResult<TResult>, int, Task> onRetryAsync)
	{
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy<TResult> AsyncRetryUntilSucceeds(Func<DelegateResult<TResult>, int, Task<RetryResult?>> onRetryAsync)
	{
		if (onRetryAsync == null) throw new ArgumentNullException(nameof(onRetryAsync));
	...
	/// <exception cref="ArgumentOutOfRangeException">retryCount;Value must be greater than or equal to zero.</exception>
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetry(int retryCount, Func<int, DelegateResult<TResult>, TimeSpan> sleepDurationProvider)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetry(int retryCount, Func<int, DelegateResult<TResult>, TimeSpan> sleepDurationProvider, Func<DelegateResult<TResult>, TimeSpan, int, Task> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetry(int retryCount, Func<int, DelegateResult<TResult>, TimeSpan> sleepDurationProvider, Func<DelegateResult<TResult>, TimeSpan, int, Task<RetryResult?>> onRetryAsync)
	{
		if (retryCount < 0)
			throw new ArgumentOutOfRangeException(nameof(retryCount), "Value must be greater than or equal to zero.");
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">sleepDurations</exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetry(IEnumerable<TimeSpan> sleepDurations)
	{
		if (sleepDurations == null)
			throw new ArgumentNullException(nameof(sleepDurations));
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetry(IEnumerable<TimeSpan> sleepDurations, Func<DelegateResult<TResult>, TimeSpan, int, Task> onRetryAsync)
	{
		if (sleepDurations == null)
			throw new ArgumentNullException(nameof(sleepDurations));
		if (onRetryAsync == null)
	...
	/// onRetryAsync
	/// </exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetry(IEnumerable<TimeSpan> sleepDurations, Func<DelegateResult<TResult>, TimeSpan, int, Task<RetryResult?>> onRetryAsync)
	{
		if (sleepDurations == null)
			throw new ArgumentNullException(nameof(sleepDurations));
		if (onRetryAsync == null)
	...
	/// <returns>The policy instance.</returns>
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetryUntilSucceeds(Func<int, DelegateResult<TResult>, TimeSpan> sleepDurationProvider)
	{
		if (sleepDurationProvider == null)
			throw new ArgumentNullException(nameof(sleepDurationProvider));
	...
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetryUntilSucceeds(Func<int, DelegateResult<TResult>, TimeSpan> sleepDurationProvider, Func<DelegateResult<TResult>, int, TimeSpan, Task> onRetryAsync)
	{
		if (sleepDurationProvider == null)
			throw new ArgumentNullException(nameof(sleepDurationProvider));
	...
	/// <exception cref="ArgumentNullException">sleepDurationProvider</exception>
	/// <exception cref="ArgumentNullException">onRetryAsync</exception>
	public AsyncRetryPolicy<TResult> AsyncWaitAndRetryUntilSucceeds(Func<int, DelegateResult<TResult>, TimeSpan> sleepDurationProvider, Func<DelegateResult<TResult>, int, TimeSpan, Task<RetryResult?>> onRetryAsync)
	{
		if (sleepDurationProvider == null)
			throw new ArgumentNullException(nameof(sleepDurationProvider));
	...
	/// <exception cref="ArgumentNullException">onFallbackAsync</exception>
	/// <returns>The policy instance.</returns>
	public AsyncFallbackPolicy<TResult> AsyncFallback(Func<DelegateResult<TResult>, CancellationToken, Task<TResult>> fallbackAction, Func<DelegateResult<TResult>, Task> onFallbackAsync)
	{
		if (fallbackAction == null)
			throw new ArgumentNullException(nameof(fallbackAction));
