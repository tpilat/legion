namespace Legion.Hardware.Options;

public class HWGathererOptions
{
	public static HWGathererOptions HWGathererOptionsForLogger => new()
	{
	...
	public static HWGathererOptions HWGathererOptionsAll => new()
	{
		GetProcessorUsage = true,
		LoadMemoryInfo = true,
		GetMemoryUsage = true,
