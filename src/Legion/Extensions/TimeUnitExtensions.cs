...
public static class TimeUnitExtensions
{
	...
	private static readonly Lazy<ReadOnlyDictionary<string, TimeUnit>> _timeUnitValueMapping =
		new(() =>
			new(
	...
	private static readonly Lazy<ReadOnlyDictionary<TimeUnit, string>> _valueTimeUnitMapping =
		new(() =>
			new(
	...
	{
		ArgOutOfRangeException.ThrowIf(!_timeUnitValueMapping.Value.TryGetValue(unit, out TimeUnit value), unit);
	...
	{
		ArgOutOfRangeException.ThrowIf(!_valueTimeUnitMapping.Value.TryGetValue(unit, out string? value), unit);
