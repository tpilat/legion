using Legion;
using Legion.DependencyInjection.Decorators;
...
public static partial class ServiceCollectionExtensions
{
	...
	{
		Throw.IfArgumentNull(services);
		Throw.IfArgumentNull(serviceType);
		Throw.IfArgumentNull(decoratorType);
	...
	{
		Throw.IfArgumentNull(services);
		Throw.IfArgumentNull(decorator);
	...
	public static IServiceCollection Decorate(this IServiceCollection services, DecorationStrategy strategy)
	{
		...
		Throw.DecorationException(ErrorCodes.DecorationException.MissingServiceType(strategy.ServiceType), null, ScopeContext.Create(nameof(DecorationException)));
