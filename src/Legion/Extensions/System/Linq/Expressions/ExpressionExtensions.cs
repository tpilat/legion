...
public static class ExpressionExtensions
{
	...
	/// </remarks>
	public static IReadOnlyList<MemberInfo> GetMemberInfoPath<T, E>(this Expression<Func<T, E>> expression, bool throwIfNoPropertyOrField = true)
		=> ReflectionHelper.GetMemberInfoPath(expression, throwIfNoPropertyOrField);
}
