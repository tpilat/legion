...
public class AspNetCoreServerKestrelEventSource : EventListener, IEventListener
{
		...
		bool autoEnable = true)
	{
		...
		ConnectionsPerSecond = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelConnectionsPerSecond));
		TlsHandshakesPerSecond = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelTlsHandshakesPerSecond));
		TotalConnections = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelTotalConnections));
		TotalTlsHandshakes = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelTotalTlsHandshakes));
		CurrentTlsHandshakes = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelCurrentTlsHandshakes));
		FailedTlsHandshakes = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelFailedTlsHandshakes));
		CurrentConnections = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelCurrentConnections));
		ConnectionQueueLength = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelConnectionQueueLength));
		RequestQueueLength = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelRequestQueueLength));
		CurrentUpgradedRequests = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreServerKestrelCurrentUpgradedRequests));
