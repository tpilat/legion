...
public class AspNetHostingEventSource : EventListener, IEventListener
{
		...
		bool autoEnable = true)
	{
		...
		CurrentRequests = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHostingCurrentRequests));
		FailedRequests = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHostingFailedRequests));
		RequestsPerSecond = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHostingRequestsPerSecond));
		TotalRequests = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHostingTotalRequests));
