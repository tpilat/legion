...
public class AspNetCoreHttpConnectionsEventSource : EventListener, IEventListener
{
		...
		bool autoEnable = true)
	{
		...
		ConnectionsDuration = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHttpConnectionsConnectionsDuration));
		CurrentConnections = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHttpConnectionsCurrentConnections));
		ConnectionsStarted = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHttpConnectionsConnectionsStarted));
		ConnectionsStopped = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHttpConnectionsConnectionsStopped));
		ConnectionsTimedOut = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.MicrosoftAspNetCoreHttpConnectionsConnectionsTimedOut));
