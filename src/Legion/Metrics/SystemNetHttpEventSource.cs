...
public class SystemNetHttpEventSource : EventListener, IEventListener
{
		...
		bool autoEnable = true)
	{
		...
		RequestsStartedRate = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpRequestsStartedRate));
		RequestsFailedRate = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpRequestsFailedRate));
		RequestsStarted = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpRequestsStarted));
		RequestsFailed = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpRequestsFailed));
		CurrentRequests = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpCurrentRequests));
		Http11ConnectionsCurrentTotal = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpHttp11ConnectionsCurrentTotal));
		Http20ConnectionsCurrentTotal = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpHttp20ConnectionsCurrentTotal));
		Http11RequestsQueueDuration = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpHttp11RequestsQueueDuration));
		Http20RequestsQueueDuration = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemNetHttpHttp20RequestsQueueDuration));
