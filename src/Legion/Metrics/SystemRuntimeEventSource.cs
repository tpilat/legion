...
public class SystemRuntimeEventSource : EventListener, IEventListener
{
		...
		bool autoEnable = true)
	{
		...
		CpuUsage = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeCpuUsage));
		WorkingSet = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeWorkingSet));
		GcHeapSize = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGcHeapSize));
		Gen0GcCount = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGen0GcCount));
		Gen1GcCount = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGen1GcCount));
		Gen2GcCount = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGen2GcCount));
		ThreadpoolThreadCount = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeThreadpoolThreadCount));
		MonitorLockContentionCount = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeMonitorLockContentionCount));
		ThreadpoolQueueLength = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeThreadpoolQueueLength));
		ThreadpoolCompletedItemsCount = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeThreadpoolCompletedItemsCount));
		AllocRate = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeAllocRate));
		ActiveTimerCount = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeActiveTimerCount));
		GcFragmentation = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGcFragmentation));
		ExceptionCount = new IncrementingEventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeExceptionCount));
		TimeInGc = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeTimeInGc));
		Gen0Size = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGen0Size));
		Gen1Size = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGen1Size));
		Gen2Size = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeGen2Size));
		LohSize = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeLohSize));
		PohSize = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimePohSize));
		AssemblyCount = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeAssemblyCount));
		IlBytesJitted = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeIlBytesJitted));
		MethodsJittedCount = new EventCounterItem(GuidConverter.ToGuid((int)EventCounterEnum.SystemRuntimeMethodsJittedCount));
		...
		: this(eventCounterIntervalSec, eventLevel, eventKeywords, false)
	{
		...
		{
			AllowedCounters = [.. allowedCounters.Keys];
			...
			false)
	{
		...
		Throw.IfArgumentNull(onUpdate);

		if (options.AllowedCounters != null)
		{
			AllowedCounters = [.. options.AllowedCounters];
