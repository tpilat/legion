using Legion.Reflection.Delegates.CustomDelegates;
...
public static partial class DelegateFactory
{
	...
	public static Func<TSource, TIndex, TReturn>? IndexerGet<TSource, TReturn, TIndex>()
		where TSource : class
	{
		var propertyInfo = typeof(TSource).GetIndexerPropertyInfo([typeof(TIndex)]);
	...
	public static Func<TSource, TIndex, TIndex2, TReturn>? IndexerGet<TSource, TReturn, TIndex, TIndex2>()
		where TSource : class
	{
		var propertyInfo = typeof(TSource).GetIndexerPropertyInfo([typeof(TIndex), typeof(TIndex2)]);
		...
		<TSource, TReturn, TIndex, TIndex2, TIndex3>() where TSource : class
	{
		var propertyInfo = typeof(TSource).GetIndexerPropertyInfo(
			[typeof(TIndex), typeof(TIndex2), typeof(TIndex3)]);
