using Legion.Reflection.Delegates.Extensions;
using System.Linq.Expressions;
using System.Reflection;
using static Legion.Reflection.Delegates.Helper.DelegateHelper;

namespace Legion.Reflection.Delegates;
...
public static partial class DelegateFactory
{
	...
	public static TDelegate? InstanceMethod<TDelegate, TParam1>(this Type source, string name)
		where TDelegate : class
	{
		return source.InstanceMethod<TDelegate>(name, [typeof(TParam1)]);
	}
	...
	public static TDelegate? InstanceMethod<TDelegate, TParam1, TParam2>(this Type source, string name)
		where TDelegate : class
	{
		return source.InstanceMethod<TDelegate>(name, [typeof(TParam1), typeof(TParam2)]);
	}
	...
	public static TDelegate? InstanceMethod<TDelegate, TParam1, TParam2, TParam3>(this Type source, string name)
		where TDelegate : class
	{
		return source.InstanceMethod<TDelegate>(name, [typeof(TParam1), typeof(TParam2), typeof(TParam3)]);
	}
