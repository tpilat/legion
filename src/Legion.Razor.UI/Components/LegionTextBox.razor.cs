...
/// <example>
/// <code>
/// &lt;LegionTextBox @bind-Value=@value Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
/// </code>
/// </example>
public partial class LegionTextBox : FormComponentWithAutoComplete<string>
{
	/// <summary>
	...
	{
		return GetClassList("lui-textbox").ToString();
	}
