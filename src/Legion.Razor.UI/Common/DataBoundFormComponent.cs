...
/// Implements the <see cref="Legion.LegionComponent" />
/// Implements the <see cref="Legion.ILegionFormComponent" />
/// </summary>
/// <typeparam name="T"></typeparam>
/// <seealso cref="Legion.LegionComponent" />
/// <seealso cref="Legion.ILegionFormComponent" />
public class DataBoundFormComponent<T> : LegionComponentBase, ILegionFormComponent
{
	/// <summary>
	...
	/// <summary> Provides support for LegionFormField integration. </summary>
	[CascadingParameter]
	public IFormFieldContext FormFieldContext { get; set; }

	/// <summary> Gets the current placeholder. Returns empty string if this component is inside a LegionFormField.</summary>
