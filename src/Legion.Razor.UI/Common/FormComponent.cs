using Legion.Razor.UI.Rendering;
...
/// <summary>
/// Class FormComponent.
/// Implements the <see cref="LegionUI.LegionUIComponent" />
/// Implements the <see cref="LegionUI.ILegionUIFormComponent" />
/// </summary>
/// <typeparam name="T"></typeparam>
/// <seealso cref="LegionUI.LegionUIComponent" />
/// <seealso cref="LegionUI.ILegionUIFormComponent" />
public class FormComponent<T> : LegionComponentBase, ILegionFormComponent
{
	/// <summary>
	...
	protected ClassList GetClassList(string className) => ClassList.Create(className)
																   ...
																   .Add("lui-state-empty", !HasValue);

	/// <summary> Provides support for LegionUIFormField integration. </summary>
	[CascadingParameter]
	public IFormFieldContext FormFieldContext { get; set; }

	/// <summary> Gets the current placeholder. Returns empty string if this component is inside a LegionUIFormField.</summary>
