...
TRUNCATE TABLE auth.[ExternalLogin];
GO

TRUNCATE TABLE auth.[LoginProvider];
GO

TRUNCATE TABLE auth.[Permission];
GO

TRUNCATE TABLE auth.[Role];
GO

TRUNCATE TABLE auth.[RolePermission];
GO

TRUNCATE TABLE auth.[User];
GO

TRUNCATE TABLE auth.[UserPermission];
GO

TRUNCATE TABLE auth.[UserRole];
GO

TRUNCATE TABLE auth.[UserToken];
GO
