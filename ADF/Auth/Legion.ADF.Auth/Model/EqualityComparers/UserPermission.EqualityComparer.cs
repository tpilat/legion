...
public sealed partial class UserPermission : Auth.AuthBaseEntity, Legion.Model.Audit.ISelfAuditableEntity, Legion.Model.Concurrence.IConcurrent, Legion.Model.Audit.IAuditableEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Auth.Model.UserPermission? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Auth.Model.UserPermission>>? conditions = null)
		=> UserPermissionEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class UserPermissionEqualityComparer : IEqualityComparer<UserPermission>
	{
		public static bool EqualsTo(
			Auth.Model.UserPermission? obj1,
			Auth.Model.UserPermission? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Auth.Model.UserPermission>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Auth.Model.UserPermission>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Auth.Model.UserPermission>();
					conditions.Invoke(conds);

					if (conds.CanCompare(obj1, nameof(obj1.IdUserPermission)) && obj1.IdUserPermission != obj2.IdUserPermission)
						return false;
				...
				{
					if (obj1.IdUserPermission != obj2.IdUserPermission)
						return false;
		...
		public Action<ComparisonConditions<Auth.Model.UserPermission>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public UserPermissionEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Auth.Model.UserPermission>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Auth.Model.UserPermission? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
