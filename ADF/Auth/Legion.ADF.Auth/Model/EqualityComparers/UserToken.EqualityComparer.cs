...
public sealed partial class UserToken : Auth.AuthBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Auth.Model.UserToken? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Auth.Model.UserToken>>? conditions = null)
		=> UserTokenEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class UserTokenEqualityComparer : IEqualityComparer<UserToken>
	{
		public static bool EqualsTo(
			Auth.Model.UserToken? obj1,
			Auth.Model.UserToken? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Auth.Model.UserToken>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Auth.Model.UserToken>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Auth.Model.UserToken>();
					conditions.Invoke(conds);

					if (conds.CanCompare(obj1, nameof(obj1.IdUserToken)) && obj1.IdUserToken != obj2.IdUserToken)
						return false;
					...
					if (conds.CanCompare(obj1, nameof(obj1.CreatedUtc)) && obj1.CreatedUtc != obj2.CreatedUtc)
						return false;
					if (conds.CanCompare(obj1, nameof(obj1.ModifiedUtc)) && obj1.ModifiedUtc != obj2.ModifiedUtc)
						return false;
				...
				{
					if (obj1.IdUserToken != obj2.IdUserToken)
						return false;
					...
					if (obj1.CreatedUtc != obj2.CreatedUtc)
						return false;
					if (obj1.ModifiedUtc != obj2.ModifiedUtc)
						return false;
		...
		public Action<ComparisonConditions<Auth.Model.UserToken>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public UserTokenEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Auth.Model.UserToken>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Auth.Model.UserToken? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
