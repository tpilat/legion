...
public partial class AuthUnitOfWorkFactory : IAuthUnitOfWorkFactory, Legion.Model.Repositories.IUnitOfWorkFactory<IAuthUnitOfWork>
{
	public IAuthUnitOfWork Create(Legion.Database.IConnectionProvider connectionProvider)
	{
		...
		return new AuthUnitOfWork(efConnectionProvider);
	}

	public IAuthUnitOfWork Create(Legion.Model.Repositories.IUnitOfWork unitOfWork)
	{
		...
		return new AuthUnitOfWork(dbUnitOfWork);
	}

	public IAuthUnitOfWork Create(Legion.Model.Repositories.IQueryUnitOfWork queryUnitOfWork)
	{
		...
		return new AuthUnitOfWork(dbQueryUnitOfWork);
	}
	...
	public IAuthUnitOfWork CreateWithoutTransaction(
		IServiceProvider serviceProvider,
		string connectionStirng,
		bool? allowLocking,
		bool createAuditEntryStore)
