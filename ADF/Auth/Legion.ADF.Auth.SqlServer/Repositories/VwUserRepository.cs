...
public partial class VwUserRepository : Legion.ADF.Auth.SqlServer.AuthQueryRepositoryBase, Legion.ADF.Auth.IAuthQueryRepository<Legion.ADF.Auth.Model.VwUser>, Legion.ADF.Auth.Model.Repositories.IVwUserRepository
{
	private readonly Lazy<Legion.ACL.IAccessControlManager<Legion.ADF.Auth.Model.VwUser>?> _accessControlManager;

	private Legion.ADF.Auth.SqlServer.IAuthQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Auth.SqlServer.IAuthQueryDbContext>(scopeContext)).VwUser;
