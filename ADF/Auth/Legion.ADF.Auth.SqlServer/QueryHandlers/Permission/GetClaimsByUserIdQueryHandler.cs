...
public class GetClaimsByUserIdQueryHandler : AsyncMessageHandlerBase<Legion.ADF.Auth.Queries.Permission.GetClaimsByUserIdQuery, System.Collections.Generic.List<System.Security.Claims.Claim>>
{
	public override async Task<IResult<System.Collections.Generic.List<System.Security.Claims.Claim>>> HandleAsync(
		IInvocationContext invocationContext,
		Legion.ADF.Auth.Queries.Permission.GetClaimsByUserIdQuery query,
		...
		CancellationToken cancellationToken = default)
	{
		...
		var data = await uow.PermissionRepository.GetClaimsByUserId(query with { AsNoTracking = true })
