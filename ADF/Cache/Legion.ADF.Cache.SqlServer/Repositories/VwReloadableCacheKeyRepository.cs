...
public partial class VwReloadableCacheKeyRepository : Legion.ADF.Cache.SqlServer.CacheQueryRepositoryBase, Legion.ADF.Cache.ICacheQueryRepository<Legion.ADF.Cache.Model.VwReloadableCacheKey>, Legion.ADF.Cache.Model.Repositories.IVwReloadableCacheKeyRepository
{
	private readonly Lazy<Legion.ACL.IAccessControlManager<Legion.ADF.Cache.Model.VwReloadableCacheKey>?> _accessControlManager;

	private Legion.ADF.Cache.SqlServer.ICacheQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Cache.SqlServer.ICacheQueryDbContext>(scopeContext)).VwReloadableCacheKey;
