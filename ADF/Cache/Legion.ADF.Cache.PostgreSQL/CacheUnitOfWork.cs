...
internal partial class CacheUnitOfWork : Legion.ADF.Cache.ICacheUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	private bool _isInternalConnectionProvider;
	private bool _disposed;

#if TRACK_OBJECTS
	public Guid IdCacheUnitOfWork { get; }
#endif
	...
	public CacheUnitOfWork(IEFConnectionProvider connectionProvider)
	{
#if TRACK_OBJECTS
		IdCacheUnitOfWork = Legion.GlobalContext.Instance.NewGuid();
		Trackers.ObjectLifetimeTracker.Track(this, IdCacheUnitOfWork.ToString());
#endif
	...
	public CacheUnitOfWork(Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork dbUnitOfWork)
	{
#if TRACK_OBJECTS
		IdCacheUnitOfWork = Legion.GlobalContext.Instance.NewGuid();
		Trackers.ObjectLifetimeTracker.Track(this, IdCacheUnitOfWork.ToString());
	...
	public CacheUnitOfWork(Legion.EntityFrameworkCore.Model.Repositories.IDbQueryUnitOfWork dbQueryUnitOfWork)
	{
#if TRACK_OBJECTS
		IdCacheUnitOfWork = Legion.GlobalContext.Instance.NewGuid();
		Trackers.ObjectLifetimeTracker.Track(this, IdCacheUnitOfWork.ToString());
	...
	public Legion.ADF.Cache.Model.Repositories.ICacheDataRepository CacheDataRepository
		=> cacheData ??= new Legion.ADF.Cache.PostgreSQL.Model.Repositories.CacheDataRepository(ConnectionProvider);
	...
	public Legion.ADF.Cache.Model.Repositories.IDistributedLockRepository DistributedLockRepository
		=> distributedLock ??= new Legion.ADF.Cache.PostgreSQL.Model.Repositories.DistributedLockRepository(ConnectionProvider);
	...
	public Legion.ADF.Cache.Model.Repositories.IReloadableCacheKeyRepository ReloadableCacheKeyRepository
		=> reloadableCacheKey ??= new Legion.ADF.Cache.PostgreSQL.Model.Repositories.ReloadableCacheKeyRepository(ConnectionProvider);
	...
	{
#if TRACK_OBJECTS
		Trackers.ObjectLifetimeTracker.SetDisposed(this, IdCacheUnitOfWork.ToString());
#endif
