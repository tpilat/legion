...
public abstract class TestBase
{
	...
	{
		var options = sp.GetRequiredService<IOptions<RestApi.Client.CacheRestApiClientOptions>>();
		var logger = sp.GetRequiredService<ILoggerFactory>().CreateLogger<NetHttp.HttpApiClient>();
		var cacheClient = new RestApi.Client.CacheRestApiClient(SetUp.HttpClient, sp, options, logger);
		return cacheClient;
	}
