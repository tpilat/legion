...
public class SetUp
{
	...
	private static async Task<IServiceScopeFactory> GetScopeFactoryAsync()
	{
		...
		using (await _servicesLock.LockAsync())
		{
			...
			services.AddInMemoryMessageBus([typeof(Cache.PostgreSQL.TableInfoProvider).Assembly, typeof(SetUp).Assembly]);
	...
	public const string usr = "cacheusr";
