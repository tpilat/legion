	...
	private readonly static Lazy<Legion.Database.Metamodel.Info.TableInfo> _JobTableInfo = new(() =>
		new Legion.Database.Metamodel.Info.TableInfo(
				...
				[
					...
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.IdDefaultHost), typeof(Guid), "\"IdDefaultHost\"", "uuid", false),
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.IdCurrentHost), typeof(Guid), "\"IdCurrentHost\"", "uuid", false),
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.AttachedToCurrentHostUtc), typeof(DateTime), "\"AttachedToCurrentHostUtc\"", "timestamp with time zone", false),
					...
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.LastProcessingFinishedUtc), typeof(DateTime?), "\"LastProcessingFinishedUtc\"", "timestamp with time zone", true),
