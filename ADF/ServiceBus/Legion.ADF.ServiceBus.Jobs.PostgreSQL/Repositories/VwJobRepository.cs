...
public partial class VwJobRepository : Legion.ADF.ServiceBus.Jobs.PostgreSQL.JobsQueryRepositoryBase, Legion.ADF.ServiceBus.Jobs.IJobsQueryRepository<Legion.ADF.ServiceBus.Jobs.Model.VwJob>, Legion.ADF.ServiceBus.Jobs.Model.Repositories.IVwJobRepository
{
	private readonly Lazy<Legion.ACL.IAccessControlManager<Legion.ADF.ServiceBus.Jobs.Model.VwJob>?> _accessControlManager;

	private Legion.ADF.ServiceBus.Jobs.PostgreSQL.IJobsQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.Jobs.PostgreSQL.IJobsQueryDbContext>(scopeContext)).VwJob;
