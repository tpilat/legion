...
public partial class JobStatusRepository : Legion.ADF.ServiceBus.Jobs.PostgreSQL.JobsRepositoryBase, Legion.ADF.ServiceBus.Jobs.IJobsRepository<Legion.ADF.ServiceBus.Jobs.Model.JobStatus>, Legion.ADF.ServiceBus.Jobs.Model.Repositories.IJobStatusRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.Jobs.PostgreSQL.IJobsDbContext>(scopeContext)).JobStatus;
