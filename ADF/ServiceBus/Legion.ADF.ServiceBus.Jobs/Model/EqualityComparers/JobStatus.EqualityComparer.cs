...
public sealed partial class JobStatus : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Jobs.Model.JobStatus? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Jobs.Model.JobStatus>>? conditions = null)
	...
	public sealed partial class JobStatusEqualityComparer : IEqualityComparer<JobStatus>
	{
		public static bool EqualsTo(
			Jobs.Model.JobStatus? obj1,
			Jobs.Model.JobStatus? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Jobs.Model.JobStatus>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Jobs.Model.JobStatus>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Jobs.Model.JobStatus>();
		...
		public Action<ComparisonConditions<Jobs.Model.JobStatus>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Jobs.Model.JobStatus? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
