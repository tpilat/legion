...
public sealed partial class JobExecution : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Jobs.Model.JobExecution? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Jobs.Model.JobExecution>>? conditions = null)
	...
	public sealed partial class JobExecutionEqualityComparer : IEqualityComparer<JobExecution>
	{
		public static bool EqualsTo(
			Jobs.Model.JobExecution? obj1,
			Jobs.Model.JobExecution? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Jobs.Model.JobExecution>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Jobs.Model.JobExecution>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Jobs.Model.JobExecution>();
		...
		public Action<ComparisonConditions<Jobs.Model.JobExecution>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Jobs.Model.JobExecution? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
