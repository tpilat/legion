...
public sealed partial class JobData : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Jobs.Model.JobData? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Jobs.Model.JobData>>? conditions = null)
	...
	public sealed partial class JobDataEqualityComparer : IEqualityComparer<JobData>
	{
		public static bool EqualsTo(
			Jobs.Model.JobData? obj1,
			Jobs.Model.JobData? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Jobs.Model.JobData>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Jobs.Model.JobData>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Jobs.Model.JobData>();
		...
		public Action<ComparisonConditions<Jobs.Model.JobData>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Jobs.Model.JobData? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
