...
public sealed partial class JobLog : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Jobs.Model.JobLog? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Jobs.Model.JobLog>>? conditions = null)
	...
	public sealed partial class JobLogEqualityComparer : IEqualityComparer<JobLog>
	{
		public static bool EqualsTo(
			Jobs.Model.JobLog? obj1,
			Jobs.Model.JobLog? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Jobs.Model.JobLog>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Jobs.Model.JobLog>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Jobs.Model.JobLog>();
		...
		public Action<ComparisonConditions<Jobs.Model.JobLog>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Jobs.Model.JobLog? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
