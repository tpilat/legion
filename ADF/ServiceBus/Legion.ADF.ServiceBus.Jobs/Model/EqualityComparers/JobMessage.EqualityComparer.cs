...
public sealed partial class JobMessage : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Jobs.Model.JobMessage? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Jobs.Model.JobMessage>>? conditions = null)
	...
	public sealed partial class JobMessageEqualityComparer : IEqualityComparer<JobMessage>
	{
		public static bool EqualsTo(
			Jobs.Model.JobMessage? obj1,
			Jobs.Model.JobMessage? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Jobs.Model.JobMessage>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Jobs.Model.JobMessage>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Jobs.Model.JobMessage>();
		...
		public Action<ComparisonConditions<Jobs.Model.JobMessage>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Jobs.Model.JobMessage? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
