...
public sealed partial class JobStatus : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	...
	private List<Jobs.Model.Job> _jobs;
	...
	/// <summary>
	/// N:_1 Jobs.Model.JobExecution.IdJobStatus | FK_JobExecution_IdJobStatus
	/// </summary>
	public IReadOnlyList<Jobs.Model.JobExecution> JobExecutions => _jobExecutions;

	/// <summary>
	/// N:_1 Jobs.Model.JobLog.IdJobStatus | FK_JobLog_IdJobStatus
	/// </summary>
	public IReadOnlyList<Jobs.Model.JobLog> JobLogs => _jobLogs;

	/// <summary>
	/// N:_1 Jobs.Model.Job.IdJobStatus | FK_Job_IdJobStatus
	/// </summary>
	public IReadOnlyList<Jobs.Model.Job> Jobs => _jobs;
