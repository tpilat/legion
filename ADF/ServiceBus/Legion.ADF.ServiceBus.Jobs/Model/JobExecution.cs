...
public sealed partial class JobExecution : Jobs.JobsBaseEntity, Legion.Model.IEntity
{
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Jobs.Model.Job.Job | FK_JobExecution_IdJob
	/// </summary>
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Jobs.Model.JobStatus.JobStatus | FK_JobExecution_IdJobStatus
	/// </summary>
