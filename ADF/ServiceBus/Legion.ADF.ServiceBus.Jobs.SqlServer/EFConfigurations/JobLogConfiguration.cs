...
public class JobLogConfiguration : IEntityTypeConfiguration<Jobs.Model.JobLog>
{
	public const string PrimaryKeyFormatter = "{{\"IdJobLog\":\"{0}\"}}";

	public void Configure(EntityTypeBuilder<Jobs.Model.JobLog> entityBuilder)
		=> ConfigureEntity(entityBuilder);

	public static void ConfigureEntity(EntityTypeBuilder<Jobs.Model.JobLog> entityBuilder)
	{
	...
	{
		modelBuilder.Entity<Jobs.Model.JobLog>(ConfigureEntity);
