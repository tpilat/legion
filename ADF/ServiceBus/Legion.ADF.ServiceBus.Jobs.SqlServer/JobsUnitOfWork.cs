...
internal partial class JobsUnitOfWork : Legion.ADF.ServiceBus.Jobs.IJobsUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	public Legion.ADF.ServiceBus.Jobs.Model.Repositories.IJobExecutionRepository JobExecutionRepository
		=> jobExecution ??= new Legion.ADF.ServiceBus.Jobs.SqlServer.Model.Repositories.JobExecutionRepository(ConnectionProvider);
	...
	public Legion.ADF.ServiceBus.Jobs.Model.Repositories.IJobStatisticsRepository JobStatisticsRepository
		=> jobStatistics ??= new Legion.ADF.ServiceBus.Jobs.SqlServer.Model.Repositories.JobStatisticsRepository(ConnectionProvider);
