	...
	private readonly static Lazy<Legion.Database.Metamodel.Info.TableInfo> _JobTableInfo = new(() =>
		new Legion.Database.Metamodel.Info.TableInfo(
				...
				[
					...
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.IdDefaultHost), typeof(Guid), "[IdDefaultHost]", "uniqueidentifier", false),
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.IdCurrentHost), typeof(Guid), "[IdCurrentHost]", "uniqueidentifier", false),
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.AttachedToCurrentHostUtc), typeof(DateTime), "[AttachedToCurrentHostUtc]", "datetime2", false),
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.LastProcessingUtc), typeof(DateTime?), "[LastProcessingUtc]", "datetime2", true),
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.Job.LastProcessingFinishedUtc), typeof(DateTime?), "[LastProcessingFinishedUtc]", "datetime2", true),
	...
	private readonly static Lazy<Legion.Database.Metamodel.Info.TableInfo> _JobStatisticsTableInfo = new(() =>
		new Legion.Database.Metamodel.Info.TableInfo(
				...
				[
					...
					new(nameof(Legion.ADF.ServiceBus.Jobs.Model.JobStatistics.StartHourUtc), typeof(DateTime), "[StartHourUtc]", "datetime2", false),
