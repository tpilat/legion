...
public partial class VwJobRepository : Legion.ADF.ServiceBus.SqlServer.ServiceBusQueryRepositoryBase, Legion.ADF.ServiceBus.IServiceBusQueryRepository<Legion.ADF.ServiceBus.Model.VwJob>, Legion.ADF.ServiceBus.Model.Repositories.IVwJobRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.SqlServer.IServiceBusQueryDbContext>(scopeContext)).VwJob;
