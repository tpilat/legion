...
public partial class VwOrchestrationRepository : Legion.ADF.ServiceBus.SqlServer.ServiceBusQueryRepositoryBase, Legion.ADF.ServiceBus.IServiceBusQueryRepository<Legion.ADF.ServiceBus.Model.VwOrchestration>, Legion.ADF.ServiceBus.Model.Repositories.IVwOrchestrationRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.SqlServer.IServiceBusQueryDbContext>(scopeContext)).VwOrchestration;
