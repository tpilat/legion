...
public partial class JobLogRepository : Legion.ADF.ServiceBus.SqlServer.ServiceBusRepositoryBase, Legion.ADF.ServiceBus.IServiceBusRepository<Legion.ADF.ServiceBus.Model.JobLog>, Legion.ADF.ServiceBus.Model.Repositories.IJobLogRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.SqlServer.IServiceBusDbContext>(scopeContext)).JobLog;
	...
	public Legion.ADF.ServiceBus.Queries.JobLog.IGetJobLogsByIdJob GetJobLogsByIdJob(
		Legion.ADF.ServiceBus.Queries.JobLog.GetJobLogsByIdJobQuery getJobLogsByIdJobQuery)
		=> new Legion.ADF.ServiceBus.Queries.JobLog.GetJobLogsByIdJob(
			ConnectionProvider,
