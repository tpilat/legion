...
public partial class ServiceBusQueryDbContext : Legion.EntityFrameworkCore.DbContextBase, Legion.ADF.ServiceBus.SqlServer.IServiceBusQueryDbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		SqlServer.VwJobConfiguration.Build(modelBuilder);
		SqlServer.VwOrchestrationConfiguration.Build(modelBuilder);
	}
}
