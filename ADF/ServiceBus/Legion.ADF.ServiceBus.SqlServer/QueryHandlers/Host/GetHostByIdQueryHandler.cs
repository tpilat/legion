...
public class GetHostByIdQueryHandler : AsyncMessageHandlerBase<Legion.ADF.ServiceBus.Queries.Host.GetHostByIdQuery, Legion.ADF.ServiceBus.Model.Host?>
{
	public override async Task<IResult<Legion.ADF.ServiceBus.Model.Host?>> HandleAsync(
		IInvocationContext invocationContext,
		Legion.ADF.ServiceBus.Queries.Host.GetHostByIdQuery query,
