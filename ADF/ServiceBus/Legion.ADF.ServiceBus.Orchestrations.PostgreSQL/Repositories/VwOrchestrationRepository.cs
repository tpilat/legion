...
public partial class VwOrchestrationRepository : Legion.ADF.ServiceBus.Orchestrations.PostgreSQL.OrchestrationsQueryRepositoryBase, Legion.ADF.ServiceBus.Orchestrations.IOrchestrationsQueryRepository<Legion.ADF.ServiceBus.Orchestrations.Model.VwOrchestration>, Legion.ADF.ServiceBus.Orchestrations.Model.Repositories.IVwOrchestrationRepository
{
	...
	private Legion.ADF.ServiceBus.Orchestrations.PostgreSQL.IOrchestrationsQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.Orchestrations.PostgreSQL.IOrchestrationsQueryDbContext>(scopeContext)).VwOrchestration;
