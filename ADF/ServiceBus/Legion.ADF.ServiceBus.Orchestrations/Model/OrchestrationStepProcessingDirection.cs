...
public sealed partial class OrchestrationStepProcessingDirection : Orchestrations.OrchestrationsBaseEntity, Legion.Model.IEntity
{
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Orchestrations.Model.OrchestrationStepProcessing.FromStep | FK_OrchestrationStepProcessingDirection_IdFromStep
	/// </summary>
	public Guid IdFromStep { get; private set; }

	/// <summary>
	/// Database DataType: uuid NOT NULL | Orchestrations.Model.OrchestrationStepProcessing.ToStep | FK_OrchestrationStepProcessingDirection_IdToStep
	/// </summary>
	...
	/// </summary>
	public Orchestrations.Model.OrchestrationStepProcessing FromStep { get; private set; }

	/// <summary>
	/// _1:N Guid IdToStep | FK_OrchestrationStepProcessingDirection_IdToStep
	/// </summary>
	public Orchestrations.Model.OrchestrationStepProcessing ToStep { get; private set; }
