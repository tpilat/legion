...
public sealed partial class OrchestrationStepProcessingDirection : Orchestrations.OrchestrationsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Orchestrations.Model.OrchestrationStepProcessingDirection? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessingDirection>>? conditions = null)
	...
	public sealed partial class OrchestrationStepProcessingDirectionEqualityComparer : IEqualityComparer<OrchestrationStepProcessingDirection>
	{
		public static bool EqualsTo(
			Orchestrations.Model.OrchestrationStepProcessingDirection? obj1,
			Orchestrations.Model.OrchestrationStepProcessingDirection? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessingDirection>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessingDirection>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessingDirection>();
		...
		public Action<ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessingDirection>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Orchestrations.Model.OrchestrationStepProcessingDirection? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
