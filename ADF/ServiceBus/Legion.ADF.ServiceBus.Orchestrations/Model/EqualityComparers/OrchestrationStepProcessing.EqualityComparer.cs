...
public sealed partial class OrchestrationStepProcessing : Orchestrations.OrchestrationsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Orchestrations.Model.OrchestrationStepProcessing? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessing>>? conditions = null)
	...
	public sealed partial class OrchestrationStepProcessingEqualityComparer : IEqualityComparer<OrchestrationStepProcessing>
	{
		public static bool EqualsTo(
			Orchestrations.Model.OrchestrationStepProcessing? obj1,
			Orchestrations.Model.OrchestrationStepProcessing? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessing>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessing>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessing>();
		...
		public Action<ComparisonConditions<Orchestrations.Model.OrchestrationStepProcessing>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Orchestrations.Model.OrchestrationStepProcessing? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
