...
public sealed partial class OrchestrationInstance : Orchestrations.OrchestrationsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Orchestrations.Model.OrchestrationInstance? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Orchestrations.Model.OrchestrationInstance>>? conditions = null)
	...
	public sealed partial class OrchestrationInstanceEqualityComparer : IEqualityComparer<OrchestrationInstance>
	{
		public static bool EqualsTo(
			Orchestrations.Model.OrchestrationInstance? obj1,
			Orchestrations.Model.OrchestrationInstance? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Orchestrations.Model.OrchestrationInstance>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Orchestrations.Model.OrchestrationInstance>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Orchestrations.Model.OrchestrationInstance>();
		...
		public Action<ComparisonConditions<Orchestrations.Model.OrchestrationInstance>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Orchestrations.Model.OrchestrationInstance? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
