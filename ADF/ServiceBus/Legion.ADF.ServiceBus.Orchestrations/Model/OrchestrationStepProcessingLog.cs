...
public sealed partial class OrchestrationStepProcessingLog : Orchestrations.OrchestrationsBaseEntity, Legion.Model.IEntity
{
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Orchestrations.Model.OrchestrationStepProcessing.OrchestrationStepProcessing | FK_OrchestrationStepProcessingLog_IdOrchStepProcessing
	/// </summary>
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Orchestrations.Model.OrchestrationStepProcessingStatus.OrchestrationStepProcessingStatus | FK_OrchestrationStepProcessingLog_IdOrchStepProcessingStatus
	/// </summary>
