...
public sealed partial class OrchestrationStep : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | ServiceBus.Model.Orchestration.Orchestration | FK_OrchestrationStep_IdOrchestration
	/// </summary>
	...
	/// <summary>
	/// N:_1 ServiceBus.Model.OrchestrationStepProcessing.IdOrchestrationStep | FK_OrchestrationStepProcessing_IdOrchestrationStep
	/// </summary>
