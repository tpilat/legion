...
public sealed partial class Job : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		...
		Action<ComparisonConditions<ServiceBus.Model.Job>>? conditions = null)
	...
	public sealed partial class JobEqualityComparer : IEqualityComparer<Job>
	{
		public static bool EqualsTo(
			ServiceBus.Model.Job? obj1,
			ServiceBus.Model.Job? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.Job>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.Job>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.Job>();
		...
		public Action<ComparisonConditions<ServiceBus.Model.Job>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.Job? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
