...
public sealed partial class JobData : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		ServiceBus.Model.JobData? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<ServiceBus.Model.JobData>>? conditions = null)
		=> JobDataEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class JobDataEqualityComparer : IEqualityComparer<JobData>
	{
		public static bool EqualsTo(
			ServiceBus.Model.JobData? obj1,
			ServiceBus.Model.JobData? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.JobData>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.JobData>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.JobData>();
					conditions.Invoke(conds);

					if (conds.CanCompare(obj1, nameof(obj1.IdJobData)) && obj1.IdJobData != obj2.IdJobData)
						return false;
					if (conds.CanCompare(obj1, nameof(obj1.IdJob)) && obj1.IdJob != obj2.IdJob)
						return false;
					if (conds.CanCompare(obj1, nameof(obj1.JobDataIdentifier)) && !string.Equals(obj1.JobDataIdentifier, obj2.JobDataIdentifier))
						return false;
					if (conds.CanCompare(obj1, nameof(obj1.CreatedUtc)) && obj1.CreatedUtc != obj2.CreatedUtc)
						return false;
					if (conds.CanCompare(obj1, nameof(obj1.LastModifiedUtc)) && obj1.LastModifiedUtc != obj2.LastModifiedUtc)
						return false;
				...
				{
					if (obj1.IdJobData != obj2.IdJobData)
						return false;
					if (obj1.IdJob != obj2.IdJob)
						return false;
					if (!string.Equals(obj1.JobDataIdentifier, obj2.JobDataIdentifier))
						return false;
					if (obj1.CreatedUtc != obj2.CreatedUtc)
						return false;
					if (obj1.LastModifiedUtc != obj2.LastModifiedUtc)
						return false;
		...
		public Action<ComparisonConditions<ServiceBus.Model.JobData>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public JobDataEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.JobData>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.JobData? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
