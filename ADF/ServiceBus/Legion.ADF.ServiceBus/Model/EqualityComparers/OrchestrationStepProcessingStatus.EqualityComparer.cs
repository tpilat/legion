...
public sealed partial class OrchestrationStepProcessingStatus : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		ServiceBus.Model.OrchestrationStepProcessingStatus? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingStatus>>? conditions = null)
	...
	public sealed partial class OrchestrationStepProcessingStatusEqualityComparer : IEqualityComparer<OrchestrationStepProcessingStatus>
	{
		public static bool EqualsTo(
			ServiceBus.Model.OrchestrationStepProcessingStatus? obj1,
			ServiceBus.Model.OrchestrationStepProcessingStatus? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingStatus>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingStatus>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingStatus>();
		...
		public Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingStatus>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.OrchestrationStepProcessingStatus? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
