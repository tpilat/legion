...
public sealed partial class OrchestrationStep : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		ServiceBus.Model.OrchestrationStep? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<ServiceBus.Model.OrchestrationStep>>? conditions = null)
	...
	public sealed partial class OrchestrationStepEqualityComparer : IEqualityComparer<OrchestrationStep>
	{
		public static bool EqualsTo(
			ServiceBus.Model.OrchestrationStep? obj1,
			ServiceBus.Model.OrchestrationStep? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.OrchestrationStep>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.OrchestrationStep>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.OrchestrationStep>();
		...
		public Action<ComparisonConditions<ServiceBus.Model.OrchestrationStep>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.OrchestrationStep? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
