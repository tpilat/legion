...
public sealed partial class OrchestrationStatus : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		ServiceBus.Model.OrchestrationStatus? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<ServiceBus.Model.OrchestrationStatus>>? conditions = null)
	...
	public sealed partial class OrchestrationStatusEqualityComparer : IEqualityComparer<OrchestrationStatus>
	{
		public static bool EqualsTo(
			ServiceBus.Model.OrchestrationStatus? obj1,
			ServiceBus.Model.OrchestrationStatus? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.OrchestrationStatus>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.OrchestrationStatus>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.OrchestrationStatus>();
		...
		public Action<ComparisonConditions<ServiceBus.Model.OrchestrationStatus>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.OrchestrationStatus? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
