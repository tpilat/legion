...
public sealed partial class OrchestrationStepProcessingLog : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		ServiceBus.Model.OrchestrationStepProcessingLog? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingLog>>? conditions = null)
	...
	public sealed partial class OrchestrationStepProcessingLogEqualityComparer : IEqualityComparer<OrchestrationStepProcessingLog>
	{
		public static bool EqualsTo(
			ServiceBus.Model.OrchestrationStepProcessingLog? obj1,
			ServiceBus.Model.OrchestrationStepProcessingLog? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingLog>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingLog>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingLog>();
		...
		public Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingLog>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.OrchestrationStepProcessingLog? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
