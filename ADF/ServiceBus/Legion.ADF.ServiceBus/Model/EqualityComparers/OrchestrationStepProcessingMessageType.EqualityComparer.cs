...
public sealed partial class OrchestrationStepProcessingMessageType : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		ServiceBus.Model.OrchestrationStepProcessingMessageType? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingMessageType>>? conditions = null)
	...
	public sealed partial class OrchestrationStepProcessingMessageTypeEqualityComparer : IEqualityComparer<OrchestrationStepProcessingMessageType>
	{
		public static bool EqualsTo(
			ServiceBus.Model.OrchestrationStepProcessingMessageType? obj1,
			ServiceBus.Model.OrchestrationStepProcessingMessageType? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingMessageType>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingMessageType>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingMessageType>();
		...
		public Action<ComparisonConditions<ServiceBus.Model.OrchestrationStepProcessingMessageType>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] ServiceBus.Model.OrchestrationStepProcessingMessageType? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
