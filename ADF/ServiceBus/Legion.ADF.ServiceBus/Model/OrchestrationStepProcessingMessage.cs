...
public sealed partial class OrchestrationStepProcessingMessage : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | ServiceBus.Model.OrchestrationStepProcessing.OrchestrationStepProcessing | FK_OrchestrationStepProcessingMessage_IdOrchStepProcessing
	/// </summary>
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | ServiceBus.Model.OrchestrationStepProcessingMessageType.OrchestrationStepProcessingMessageType | FK_OrchestrationStepProcessingMessage_IdOrchStepProcessingMessa
	/// </summary>
	...
	/// </summary>
	public ServiceBus.Model.OrchestrationStepProcessingMessageType OrchestrationStepProcessingMessageType { get; private set; }
