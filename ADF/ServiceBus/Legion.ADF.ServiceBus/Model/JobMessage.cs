...
public sealed partial class JobMessage : ServiceBus.ServiceBusBaseEntity, Legion.Model.IEntity
{
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | ServiceBus.Model.Job.Job | FK_JobMessage_IdJob
	/// </summary>
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | ServiceBus.Model.JobMessageType.JobMessageType | FK_JobMessage_IdJobMessageType
	/// </summary>
	...
	/// </summary>
	public ServiceBus.Model.JobMessageType JobMessageType { get; private set; }
