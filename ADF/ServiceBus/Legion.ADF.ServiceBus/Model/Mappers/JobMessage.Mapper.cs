...
{
	public static ServiceBus.Model.JobMessage? Map(
		ServiceBus.Model.JobMessage source,
		ServiceBus.Model.JobMessage? target,
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<ServiceBus.Model.JobMessage>>? conditions = null,
	...
	public ServiceBus.Model.JobMessage? Clone(
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<ServiceBus.Model.JobMessage>>? conditions = null,
		Legion.Reflection.InstanceFactory? instanceFactory = null,
		Dictionary<object, object>? cache = null)
	...
	public ServiceBus.Model.JobMessage? MapTo(
		ServiceBus.Model.JobMessage? target,
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<ServiceBus.Model.JobMessage>>? conditions = null,
		Legion.Reflection.InstanceFactory? instanceFactory = null,
	...
	{
		cache ??= [];
		target ??= instanceFactory?.CreateInstance<Legion.ADF.ServiceBus.Model.JobMessage>(
				useActivatorIfNoFactoryFound: false,
				throwIfFactoryReturnsNull: true)
			?? new Legion.ADF.ServiceBus.Model.JobMessage();

		if (cache.TryGetValue(this, out var cached))
			return (ServiceBus.Model.JobMessage)cached;
			
		MappingConditions<ServiceBus.Model.JobMessage>? conds = null;
		if (conditions != null)
		{
			conds = new MappingConditions<ServiceBus.Model.JobMessage>();
