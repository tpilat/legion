...
internal partial class HostsUnitOfWork : Legion.ADF.ServiceBus.Hosts.IHostsUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	public Legion.ADF.ServiceBus.Hosts.Model.Repositories.IHostRepository HostRepository
		=> host ??= new Legion.ADF.ServiceBus.Hosts.SqlServer.Model.Repositories.HostRepository(ConnectionProvider);
	...
	public Legion.ADF.ServiceBus.Hosts.Model.Repositories.IHostLogRepository HostLogRepository
		=> hostLog ??= new Legion.ADF.ServiceBus.Hosts.SqlServer.Model.Repositories.HostLogRepository(ConnectionProvider);
