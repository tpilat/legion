...
public class GetHostByNameQueryHandler : AsyncMessageHandlerBase<Legion.ADF.ServiceBus.Hosts.Queries.Host.GetHostByNameQuery, Legion.ADF.ServiceBus.Hosts.Model.Host?>
{
	public override async Task<IResult<Legion.ADF.ServiceBus.Hosts.Model.Host?>> HandleAsync(
		IInvocationContext invocationContext,
		Legion.ADF.ServiceBus.Hosts.Queries.Host.GetHostByNameQuery query,
