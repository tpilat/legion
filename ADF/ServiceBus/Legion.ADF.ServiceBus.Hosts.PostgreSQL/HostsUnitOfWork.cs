...
internal partial class HostsUnitOfWork : Legion.ADF.ServiceBus.Hosts.IHostsUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	private bool _isInternalConnectionProvider;
	private bool _disposed;

#if TRACK_OBJECTS
	public Guid IdHostsUnitOfWork { get; }
#endif
	...
	public HostsUnitOfWork(IEFConnectionProvider connectionProvider)
	{
#if TRACK_OBJECTS
		IdHostsUnitOfWork = Guid.NewGuid();
		Trackers.ObjectLifetimeTracker.Track(this, IdHostsUnitOfWork.ToString());
#endif
	...
	public HostsUnitOfWork(Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork dbUnitOfWork)
	{
#if TRACK_OBJECTS
		IdHostsUnitOfWork = Guid.NewGuid();
		Trackers.ObjectLifetimeTracker.Track(this, IdHostsUnitOfWork.ToString());
	...
	public HostsUnitOfWork(Legion.EntityFrameworkCore.Model.Repositories.IDbQueryUnitOfWork dbQueryUnitOfWork)
	{
#if TRACK_OBJECTS
		IdHostsUnitOfWork = Guid.NewGuid();
		Trackers.ObjectLifetimeTracker.Track(this, IdHostsUnitOfWork.ToString());
	...
	private Legion.ADF.ServiceBus.Hosts.Model.Repositories.IHostRepository? host;
	public Legion.ADF.ServiceBus.Hosts.Model.Repositories.IHostRepository HostRepository
		=> host ??= new Legion.ADF.ServiceBus.Hosts.PostgreSQL.Model.Repositories.HostRepository(ConnectionProvider);


	private Legion.ADF.ServiceBus.Hosts.Model.Repositories.IHostLogRepository? hostLog;
	public Legion.ADF.ServiceBus.Hosts.Model.Repositories.IHostLogRepository HostLogRepository
		=> hostLog ??= new Legion.ADF.ServiceBus.Hosts.PostgreSQL.Model.Repositories.HostLogRepository(ConnectionProvider);
	...
	{
#if TRACK_OBJECTS
		Trackers.ObjectLifetimeTracker.SetDisposed(this, IdHostsUnitOfWork.ToString());
#endif
