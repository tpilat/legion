...
public partial class HostsUnitOfWorkFactory : IHostsUnitOfWorkFactory
{
	public IHostsUnitOfWork Create(Legion.Database.IConnectionProvider connectionProvider)
	{
		...
		return new HostsUnitOfWork(efConnectionProvider);
	}

	public IHostsUnitOfWork Create(Legion.Model.Repositories.IUnitOfWork unitOfWork)
	{
		...
		return new HostsUnitOfWork(dbUnitOfWork);
	}

	public IHostsUnitOfWork Create(Legion.Model.Repositories.IQueryUnitOfWork queryUnitOfWork)
	{
		...
		return new HostsUnitOfWork(dbQueryUnitOfWork);
	}

	public IHostsUnitOfWork Create(
	...
	public IHostsUnitOfWork CreateWithoutTransaction(
		IServiceProvider serviceProvider,
		string connectionStirng,
		bool? allowLocking,
		bool createAuditEntryStore)
