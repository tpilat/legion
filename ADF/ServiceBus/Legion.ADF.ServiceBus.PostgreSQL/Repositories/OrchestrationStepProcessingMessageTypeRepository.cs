...
public partial class OrchestrationStepProcessingMessageTypeRepository : Legion.ADF.ServiceBus.PostgreSQL.ServiceBusRepositoryBase, Legion.ADF.ServiceBus.IServiceBusRepository<Legion.ADF.ServiceBus.Model.OrchestrationStepProcessingMessageType>, Legion.ADF.ServiceBus.Model.Repositories.IOrchestrationStepProcessingMessageTypeRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.PostgreSQL.IServiceBusDbContext>(scopeContext)).OrchestrationStepProcessingMessageType;
