...
public partial class VwHostRepository : Legion.ADF.ServiceBus.PostgreSQL.ServiceBusQueryRepositoryBase, Legion.ADF.ServiceBus.IServiceBusQueryRepository<Legion.ADF.ServiceBus.Model.VwHost>, Legion.ADF.ServiceBus.Model.Repositories.IVwHostRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.ServiceBus.PostgreSQL.IServiceBusQueryDbContext>(scopeContext)).VwHost;
