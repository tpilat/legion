...
public class JobMessageConfiguration : IEntityTypeConfiguration<ServiceBus.Model.JobMessage>
{
	public const string PrimaryKeyFormatter = "{{\"IdJobMessage\":\"{0}\"}}";

	public void Configure(EntityTypeBuilder<ServiceBus.Model.JobMessage> entityBuilder)
		=> ConfigureEntity(entityBuilder);

	public static void ConfigureEntity(EntityTypeBuilder<ServiceBus.Model.JobMessage> entityBuilder)
	{
	...
	{
		modelBuilder.Entity<ServiceBus.Model.JobMessage>(ConfigureEntity);
