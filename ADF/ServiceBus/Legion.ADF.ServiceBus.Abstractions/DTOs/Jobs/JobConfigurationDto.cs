...
public class JobConfigurationDto
{
	...
	public readonly static Lazy<IValidator<JobConfigurationDto>> DefaultValidator = new(() => SetValidatorRules(new ValidatorBuilder<JobConfigurationDto>()).Build());

	public bool ShouldSerializeDefaultValidator()
		=> false;

	public static ValidatorBuilder<JobConfigurationDto> SetValidatorRules(ValidatorBuilder<JobConfigurationDto> builder)
		=> builder
