...
{
	private List<Hosts.Model.HostLog> _hostLogs;
	...
	/// <summary>
	/// N:_1 Hosts.Model.HostLog.IdHost | FK_HostLog_IdHost
	/// </summary>
	public IReadOnlyList<Hosts.Model.HostLog> HostLogs => _hostLogs;
