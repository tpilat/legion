...
public sealed partial class HostLog : Hosts.HostsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Hosts.Model.HostLog? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Hosts.Model.HostLog>>? conditions = null)
	...
	public sealed partial class HostLogEqualityComparer : IEqualityComparer<HostLog>
	{
		public static bool EqualsTo(
			Hosts.Model.HostLog? obj1,
			Hosts.Model.HostLog? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Hosts.Model.HostLog>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Hosts.Model.HostLog>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Hosts.Model.HostLog>();
		...
		public Action<ComparisonConditions<Hosts.Model.HostLog>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] Hosts.Model.HostLog? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
