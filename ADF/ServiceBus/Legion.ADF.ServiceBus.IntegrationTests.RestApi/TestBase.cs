...
public abstract class TestBase
{
	...
	public IServiceBusMonitor GetServiceBusMonitor(IServiceProvider sp)
	{
		var options = sp.GetRequiredService<IOptions<RestApi.Client.ServiceBusRestApiClientOptions>>();
		var logger = sp.GetRequiredService<ILoggerFactory>().CreateLogger<NetHttp.HttpApiClient>();
		var serviceBusClient = new RestApi.Client.ServiceBusRestApiClient(SetUp.HttpClient, sp, options, logger);
