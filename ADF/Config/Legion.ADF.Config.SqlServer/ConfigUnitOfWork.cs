...
internal partial class ConfigUnitOfWork : Legion.ADF.Config.IConfigUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	public Legion.ADF.Config.Model.Repositories.IConfigurationClassRepository ConfigurationClassRepository
		=> configurationClass ??= new Legion.ADF.Config.SqlServer.Model.Repositories.ConfigurationClassRepository(ConnectionProvider);
	...
	public Legion.ADF.Config.Model.Repositories.IConfigurationKeyValueRepository ConfigurationKeyValueRepository
		=> configurationKeyValue ??= new Legion.ADF.Config.SqlServer.Model.Repositories.ConfigurationKeyValueRepository(ConnectionProvider);
