...
public partial class VwConfigurationClassRepository : Legion.ADF.Config.SqlServer.ConfigQueryRepositoryBase, Legion.ADF.Config.IConfigQueryRepository<Legion.ADF.Config.Model.VwConfigurationClass>, Legion.ADF.Config.Model.Repositories.IVwConfigurationClassRepository
{
	...
	private Legion.ADF.Config.SqlServer.IConfigQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Config.SqlServer.IConfigQueryDbContext>(scopeContext)).VwConfigurationClass;
