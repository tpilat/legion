...
public class GetAllConfigurationKeyValues :
	QueryDefinition<
		IConfigDbContext,
		Config.Model.ConfigurationKeyValue,
		List<Config.Model.ConfigurationKeyValue>,
		GetAllConfigurationKeyValuesQuery>,
	IGetAllConfigurationKeyValues
{
	public GetAllConfigurationKeyValues(
		IEFConnectionProvider connectionProvider,
		GetAllConfigurationKeyValuesQuery getAllConfigurationKeyValuesQuery)
		: base(connectionProvider, getAllConfigurationKeyValuesQuery)
	{
	}
