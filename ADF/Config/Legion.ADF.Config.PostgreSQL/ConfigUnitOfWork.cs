...
internal partial class ConfigUnitOfWork : Legion.ADF.Config.IConfigUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	private bool _isInternalConnectionProvider;
	private bool _disposed;

#if TRACK_OBJECTS
	public Guid IdConfigUnitOfWork { get; }
#endif
	...
	private Legion.ADF.Config.Model.Repositories.IConfigurationClassRepository? configurationClass;
	public Legion.ADF.Config.Model.Repositories.IConfigurationClassRepository ConfigurationClassRepository
		=> configurationClass ??= new Legion.ADF.Config.PostgreSQL.Model.Repositories.ConfigurationClassRepository(ConnectionProvider);


	private Legion.ADF.Config.Model.Repositories.IConfigurationKeyValueRepository? configurationKeyValue;
	public Legion.ADF.Config.Model.Repositories.IConfigurationKeyValueRepository ConfigurationKeyValueRepository
		=> configurationKeyValue ??= new Legion.ADF.Config.PostgreSQL.Model.Repositories.ConfigurationKeyValueRepository(ConnectionProvider);
	...
	{
#if TRACK_OBJECTS
		Trackers.ObjectLifetimeTracker.SetDisposed(this, IdConfigUnitOfWork.ToString());
#endif
