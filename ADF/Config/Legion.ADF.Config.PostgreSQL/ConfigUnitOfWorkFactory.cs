...
public partial class ConfigUnitOfWorkFactory : IConfigUnitOfWorkFactory
{
	public IConfigUnitOfWork Create(Legion.Database.IConnectionProvider connectionProvider)
	{
		...
		return new ConfigUnitOfWork(efConnectionProvider);
	}

	public IConfigUnitOfWork Create(Legion.Model.Repositories.IUnitOfWork unitOfWork)
	{
		...
		return new ConfigUnitOfWork(dbUnitOfWork);
	}

	public IConfigUnitOfWork Create(Legion.Model.Repositories.IQueryUnitOfWork queryUnitOfWork)
	{
		...
		return new ConfigUnitOfWork(dbQueryUnitOfWork);
	}

	public IConfigUnitOfWork Create(
		IServiceProvider serviceProvider,
		string connectionStirng,
		System.Data.IsolationLevel? isolationLevel,
		bool? allowLocking,
		bool createAuditEntryStore)
		=> new ConfigUnitOfWork(
			serviceProvider,
			connectionStirng,
			isolationLevel,
			allowLocking,
	...
	public IConfigUnitOfWork CreateWithoutTransaction(
		IServiceProvider serviceProvider,
		string connectionStirng,
		bool? allowLocking,
		bool createAuditEntryStore)
