...
{
	public const string PREFIX = "ADFLogs";
...
public static class AppSettingsExtensions
{
	public static IServiceCollection AddAppSettings(this IServiceCollection services)
	{
		...
		services.AddLoggerSettings();
		services.AddLogsStoreOptions();
		services.AddBatchLogMessageStoreOptions();
		services.AddBatchUnstructuredLogStoreOptions();
