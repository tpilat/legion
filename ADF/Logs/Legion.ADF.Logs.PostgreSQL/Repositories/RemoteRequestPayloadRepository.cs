...
public partial class RemoteRequestPayloadRepository : Legion.ADF.Logs.PostgreSQL.LogsRepositoryBase, Legion.ADF.Logs.ILogsRepository<Legion.ADF.Logs.Model.RemoteRequestPayload>, Legion.ADF.Logs.Model.Repositories.IRemoteRequestPayloadRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Logs.PostgreSQL.ILogsDbContext>(scopeContext)).RemoteRequestPayload;
