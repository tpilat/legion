...
public partial class LocalResponsePayloadRepository : Legion.ADF.Logs.PostgreSQL.LogsRepositoryBase, Legion.ADF.Logs.ILogsRepository<Legion.ADF.Logs.Model.LocalResponsePayload>, Legion.ADF.Logs.Model.Repositories.ILocalResponsePayloadRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Logs.PostgreSQL.ILogsDbContext>(scopeContext)).LocalResponsePayload;
