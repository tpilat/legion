...
internal partial class LogsUnitOfWork : Legion.ADF.Logs.ILogsUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	public Legion.ADF.Logs.Model.Repositories.IEnvironmentInfoRepository EnvironmentInfoRepository
		=> environmentInfo ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.EnvironmentInfoRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IEventCounterRepository EventCounterRepository
		=> eventCounter ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.EventCounterRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IEventCounterCategoryRepository EventCounterCategoryRepository
		=> eventCounterCategory ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.EventCounterCategoryRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IEventCounterDataRepository EventCounterDataRepository
		=> eventCounterData ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.EventCounterDataRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.ILocalRequestRepository LocalRequestRepository
		=> localRequest ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.LocalRequestRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.ILocalRequestPayloadRepository LocalRequestPayloadRepository
		=> localRequestPayload ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.LocalRequestPayloadRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.ILocalResponseRepository LocalResponseRepository
		=> localResponse ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.LocalResponseRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.ILocalResponsePayloadRepository LocalResponsePayloadRepository
		=> localResponsePayload ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.LocalResponsePayloadRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.ILogRepository LogRepository
		=> log ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.LogRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.ILogLevelRepository LogLevelRepository
		=> logLevel ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.LogLevelRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IRemoteRequestRepository RemoteRequestRepository
		=> remoteRequest ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.RemoteRequestRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IRemoteRequestPayloadRepository RemoteRequestPayloadRepository
		=> remoteRequestPayload ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.RemoteRequestPayloadRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IRemoteResponseRepository RemoteResponseRepository
		=> remoteResponse ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.RemoteResponseRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IRemoteResponsePayloadRepository RemoteResponsePayloadRepository
		=> remoteResponsePayload ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.RemoteResponsePayloadRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IRemoteSystemRepository RemoteSystemRepository
		=> remoteSystem ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.RemoteSystemRepository(ConnectionProvider);
	...
	public Legion.ADF.Logs.Model.Repositories.IUnstructuredLogRepository UnstructuredLogRepository
		=> unstructuredLog ??= new Legion.ADF.Logs.PostgreSQL.Model.Repositories.UnstructuredLogRepository(ConnectionProvider);
