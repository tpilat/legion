...
public partial class VwLogRepository : Legion.ADF.Logs.SqlServer.LogsQueryRepositoryBase, Legion.ADF.Logs.ILogsQueryRepository<Legion.ADF.Logs.Model.VwLog>, Legion.ADF.Logs.Model.Repositories.IVwLogRepository
{
	private readonly Lazy<Legion.ACL.IAccessControlManager<Legion.ADF.Logs.Model.VwLog>?> _accessControlManager;

	private Legion.ADF.Logs.SqlServer.ILogsQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Logs.SqlServer.ILogsQueryDbContext>(scopeContext)).VwLog;
