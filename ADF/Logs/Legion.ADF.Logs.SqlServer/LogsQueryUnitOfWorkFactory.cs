...
public partial class LogsQueryUnitOfWorkFactory : ILogsQueryUnitOfWorkFactory
{
	public ILogsQueryUnitOfWork Create(Legion.Database.IConnectionProvider connectionProvider)
	{
		...
		return new LogsQueryUnitOfWork(efConnectionProvider);
	}

	public ILogsQueryUnitOfWork Create(Legion.Model.Repositories.IUnitOfWork unitOfWork)
	{
		...
		return new LogsQueryUnitOfWork(dbUnitOfWork);
	}

	public ILogsQueryUnitOfWork Create(Legion.Model.Repositories.IQueryUnitOfWork queryUnitOfWork)
	{
		...
		return new LogsQueryUnitOfWork(dbQueryUnitOfWork);
	}

	public ILogsQueryUnitOfWork Create(
		IServiceProvider serviceProvider,
		string connectionStirng,
		System.Data.IsolationLevel? isolationLevel,
		bool? allowLocking,
		bool createAuditEntryStore)
		=> new LogsQueryUnitOfWork(
			serviceProvider,
			connectionStirng,
			isolationLevel,
			allowLocking,
	...
	public ILogsQueryUnitOfWork CreateWithoutTransaction(
		IServiceProvider serviceProvider,
		string connectionStirng,
		bool? allowLocking,
		bool createAuditEntryStore)
