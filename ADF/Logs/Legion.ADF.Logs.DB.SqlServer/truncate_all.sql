...
TRUNCATE TABLE log.[EnvironmentInfo];
GO

TRUNCATE TABLE log.[EventCounterData];
GO

TRUNCATE TABLE log.[LocalRequest];
GO

TRUNCATE TABLE log.[LocalRequestPayload];
GO

TRUNCATE TABLE log.[LocalResponse];
GO

TRUNCATE TABLE log.[LocalResponsePayload];
GO

TRUNCATE TABLE log.[Log];
GO

TRUNCATE TABLE log.[RemoteRequest];
GO

TRUNCATE TABLE log.[RemoteRequestPayload];
GO

TRUNCATE TABLE log.[RemoteResponse];
GO

TRUNCATE TABLE log.[RemoteResponsePayload];
GO

TRUNCATE TABLE log.[RemoteSystem];
GO

TRUNCATE TABLE log.[UnstructuredLog];
GO

--TRUNCATE TABLE log.[LogLevel];
--GO

--TRUNCATE TABLE log.[EventCounterCategory];
--GO

--TRUNCATE TABLE log.[EventCounter];
--GO
