...
public class SetUp
{
	...
	public static string ConncetionString => "Server=127.0.0.1;Database=legion_adf_logs;User Id=sa;Password=Password1.;TrustServerCertificate=True;MultipleActiveResultSets=true";
	...
	private static async Task<IServiceScopeFactory> GetScopeFactoryAsync()
	{
		...
		using (await _servicesLock.LockAsync())
		{
			...
			services.AddInMemoryMessageBus([typeof(Logs.SqlServer.TableInfoProvider).Assembly, typeof(SetUp).Assembly]);
