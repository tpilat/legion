...
public sealed partial class RemoteRequestPayload : Logs.LogsBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Logs.Model.RemoteRequestPayload? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Logs.Model.RemoteRequestPayload>>? conditions = null)
		=> RemoteRequestPayloadEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class RemoteRequestPayloadEqualityComparer : IEqualityComparer<RemoteRequestPayload>
	{
		public static bool EqualsTo(
			Logs.Model.RemoteRequestPayload? obj1,
			Logs.Model.RemoteRequestPayload? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Logs.Model.RemoteRequestPayload>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Logs.Model.RemoteRequestPayload>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Logs.Model.RemoteRequestPayload>();
					conditions.Invoke(conds);

					if (conds.CanCompare(obj1, nameof(obj1.IdRemoteRequestPayload)) && obj1.IdRemoteRequestPayload != obj2.IdRemoteRequestPayload)
						return false;
				...
				{
					if (obj1.IdRemoteRequestPayload != obj2.IdRemoteRequestPayload)
						return false;
		...
		public Action<ComparisonConditions<Logs.Model.RemoteRequestPayload>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public RemoteRequestPayloadEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Logs.Model.RemoteRequestPayload>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Logs.Model.RemoteRequestPayload? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
