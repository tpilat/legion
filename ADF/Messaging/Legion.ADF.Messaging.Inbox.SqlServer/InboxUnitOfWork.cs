...
internal partial class InboxUnitOfWork : Legion.ADF.Messaging.Inbox.IInboxUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	{
#if TRACK_OBJECTS
		IdInboxUnitOfWork = Guid.NewGuid();
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IBlockedInboxMessageTypeRepository BlockedInboxMessageTypeRepository
		=> blockedInboxMessageType ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.BlockedInboxMessageTypeRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxInstanceRepository InboxInstanceRepository
		=> inboxInstance ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxInstanceRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxMessageRepository InboxMessageRepository
		=> inboxMessage ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxMessageRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxMessageArchiveRepository InboxMessageArchiveRepository
		=> inboxMessageArchive ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxMessageArchiveRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxMessageContentRepository InboxMessageContentRepository
		=> inboxMessageContent ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxMessageContentRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxMessageProcessingLogRepository InboxMessageProcessingLogRepository
		=> inboxMessageProcessingLog ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxMessageProcessingLogRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxMessageStatusRepository InboxMessageStatusRepository
		=> inboxMessageStatus ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxMessageStatusRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxMessageTypeRepository InboxMessageTypeRepository
		=> inboxMessageType ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxMessageTypeRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxProcessingLogRepository InboxProcessingLogRepository
		=> inboxProcessingLog ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxProcessingLogRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxQueueRepository InboxQueueRepository
		=> inboxQueue ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxQueueRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Inbox.Model.Repositories.IInboxQueueProcessingModeRepository InboxQueueProcessingModeRepository
		=> inboxQueueProcessingMode ??= new Legion.ADF.Messaging.Inbox.SqlServer.Model.Repositories.InboxQueueProcessingModeRepository(ConnectionProvider);
