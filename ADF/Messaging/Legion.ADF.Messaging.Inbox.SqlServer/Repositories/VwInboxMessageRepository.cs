...
public partial class VwInboxMessageRepository : Legion.ADF.Messaging.Inbox.SqlServer.InboxQueryRepositoryBase, Legion.ADF.Messaging.Inbox.IInboxQueryRepository<Legion.ADF.Messaging.Inbox.Model.VwInboxMessage>, Legion.ADF.Messaging.Inbox.Model.Repositories.IVwInboxMessageRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.Inbox.SqlServer.IInboxQueryDbContext>(scopeContext)).VwInboxMessage;
