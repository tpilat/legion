...
public partial class VwBlockedInboxMessageTypeRepository : Legion.ADF.Messaging.Inbox.SqlServer.InboxQueryRepositoryBase, Legion.ADF.Messaging.Inbox.IInboxQueryRepository<Legion.ADF.Messaging.Inbox.Model.VwBlockedInboxMessageType>, Legion.ADF.Messaging.Inbox.Model.Repositories.IVwBlockedInboxMessageTypeRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.Inbox.SqlServer.IInboxQueryDbContext>(scopeContext)).VwBlockedInboxMessageType;
