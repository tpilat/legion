...
public class VwInboxMessageArchiveConfiguration : IEntityTypeConfiguration<Inbox.Model.VwInboxMessageArchive>
{
	public void Configure(EntityTypeBuilder<Inbox.Model.VwInboxMessageArchive> entityBuilder)
		=> ConfigureEntity(entityBuilder);

	public static void ConfigureEntity(EntityTypeBuilder<Inbox.Model.VwInboxMessageArchive> entityBuilder)
	{
		entityBuilder.ToView("VwInboxMessageArchive", "inbox")
			.HasNoKey();
	...
	public static ModelBuilder Build(ModelBuilder modelBuilder)
		=> modelBuilder.Entity<Inbox.Model.VwInboxMessageArchive>(ConfigureEntity);
}
