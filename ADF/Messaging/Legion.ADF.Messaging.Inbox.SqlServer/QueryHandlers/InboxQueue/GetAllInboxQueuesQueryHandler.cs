...
public class GetAllInboxQueuesQueryHandler : AsyncMessageHandlerBase<Legion.ADF.Messaging.Inbox.Queries.InboxQueue.GetAllInboxQueuesQuery, System.Collections.Generic.List<Legion.ADF.Messaging.Inbox.Model.InboxQueue>>
{
	public override async Task<IResult<System.Collections.Generic.List<Legion.ADF.Messaging.Inbox.Model.InboxQueue>>> HandleAsync(
		...
		Legion.ADF.Messaging.Inbox.Queries.InboxQueue.GetAllInboxQueuesQuery query,
		...
		CancellationToken cancellationToken = default)
	{
		...
		var data = await uow.InboxQueueRepository.GetAllInboxQueues(query with { AsNoTracking = true })
