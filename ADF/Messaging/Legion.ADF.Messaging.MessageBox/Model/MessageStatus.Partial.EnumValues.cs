...
public partial class MessageStatus : MessageBox.MessageBoxBaseEntity, Legion.Model.IEntity, IComparable
{
	/// <summary>
	/// 00000001-0000-0000-0000-000000000000
	/// </summary>
	public static MessageStatus Created_NewObject => new(new Guid("00000001-0000-0000-0000-000000000000"), "Created", "Created");

	/// <summary>
	/// 00000002-0000-0000-0000-000000000000
	/// </summary>
	public static MessageStatus Processed_NewObject => new(new Guid("00000002-0000-0000-0000-000000000000"), "Processed", "Processed");

	/// <summary>
	/// 00000003-0000-0000-0000-000000000000
	/// </summary>
	public static MessageStatus Dropped_NewObject => new(new Guid("00000003-0000-0000-0000-000000000000"), "Dropped", "Dropped  (due to valid to)");
	...
	public static readonly Lazy<IReadOnlyDictionary<Guid, MessageStatus>> DictionaryMap = new(() => new Dictionary<Guid, MessageStatus>
	{
			...
			{ new Guid("00000002-0000-0000-0000-000000000000"), Processed_NewObject },
			{ new Guid("00000003-0000-0000-0000-000000000000"), Dropped_NewObject }
	});
