...
public sealed partial class Message : MessageBox.MessageBoxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		MessageBox.Model.Message? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<MessageBox.Model.Message>>? conditions = null)
		=> MessageEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class MessageEqualityComparer : IEqualityComparer<Message>
	{
		public static bool EqualsTo(
			MessageBox.Model.Message? obj1,
			MessageBox.Model.Message? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.Message>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<MessageBox.Model.Message>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<MessageBox.Model.Message>();
		...
		public Action<ComparisonConditions<MessageBox.Model.Message>>? Conditions { get; }
		...
		public int GetHashCode([DisallowNull] MessageBox.Model.Message? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
