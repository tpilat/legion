...
public sealed partial class QueuedMessage : MessageBox.MessageBoxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		MessageBox.Model.QueuedMessage? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<MessageBox.Model.QueuedMessage>>? conditions = null)
		=> QueuedMessageEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class QueuedMessageEqualityComparer : IEqualityComparer<QueuedMessage>
	{
		public static bool EqualsTo(
			MessageBox.Model.QueuedMessage? obj1,
			MessageBox.Model.QueuedMessage? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.QueuedMessage>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<MessageBox.Model.QueuedMessage>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<MessageBox.Model.QueuedMessage>();
		...
		public Action<ComparisonConditions<MessageBox.Model.QueuedMessage>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public QueuedMessageEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.QueuedMessage>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] MessageBox.Model.QueuedMessage? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
