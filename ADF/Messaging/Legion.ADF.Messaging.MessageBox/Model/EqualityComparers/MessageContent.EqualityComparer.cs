...
public sealed partial class MessageContent : MessageBox.MessageBoxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		MessageBox.Model.MessageContent? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<MessageBox.Model.MessageContent>>? conditions = null)
		=> MessageContentEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class MessageContentEqualityComparer : IEqualityComparer<MessageContent>
	{
		public static bool EqualsTo(
			MessageBox.Model.MessageContent? obj1,
			MessageBox.Model.MessageContent? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.MessageContent>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<MessageBox.Model.MessageContent>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<MessageBox.Model.MessageContent>();
			...
			{
				if (!Message.MessageEqualityComparer.EqualsTo(obj1.Message, obj2.Message, comparisonOptions, conds?.GetConditions(x => x.Message), cache))
					return false;
				if (!MessageArchive.MessageArchiveEqualityComparer.EqualsTo(obj1.MessageArchive, obj2.MessageArchive, comparisonOptions, conds?.GetConditions(x => x.MessageArchive), cache))
					return false;
		}
		...
		public Action<ComparisonConditions<MessageBox.Model.MessageContent>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public MessageContentEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.MessageContent>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] MessageBox.Model.MessageContent? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
