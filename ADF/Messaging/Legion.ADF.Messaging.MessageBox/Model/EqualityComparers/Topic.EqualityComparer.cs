...
public sealed partial class Topic : MessageBox.MessageBoxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		MessageBox.Model.Topic? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<MessageBox.Model.Topic>>? conditions = null)
		=> TopicEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class TopicEqualityComparer : IEqualityComparer<Topic>
	{
		public static bool EqualsTo(
			MessageBox.Model.Topic? obj1,
			MessageBox.Model.Topic? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.Topic>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<MessageBox.Model.Topic>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<MessageBox.Model.Topic>();
		...
		public Action<ComparisonConditions<MessageBox.Model.Topic>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public TopicEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<MessageBox.Model.Topic>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] MessageBox.Model.Topic? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
