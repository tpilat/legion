...
public class GetAllQueuesQueryHandler : AsyncMessageHandlerBase<Legion.ADF.Messaging.MessageBox.Queries.Queue.GetAllQueuesQuery, System.Collections.Generic.List<Legion.ADF.Messaging.MessageBox.Model.Queue>>
{
	public override async Task<IResult<System.Collections.Generic.List<Legion.ADF.Messaging.MessageBox.Model.Queue>>> HandleAsync(
		...
		Legion.ADF.Messaging.MessageBox.Queries.Queue.GetAllQueuesQuery query,
		...
		CancellationToken cancellationToken = default)
	{
		...
		var data = await uow.QueueRepository.GetAllQueues(query with { AsNoTracking = true })
