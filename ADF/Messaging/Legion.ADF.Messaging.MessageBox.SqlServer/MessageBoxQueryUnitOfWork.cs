...
internal partial class MessageBoxQueryUnitOfWork : Legion.ADF.Messaging.MessageBox.IMessageBoxQueryUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbQueryUnitOfWork, Legion.Model.Repositories.IQueryUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	{
#if TRACK_OBJECTS
		IdMessageBoxQueryUnitOfWork = Legion.GlobalContext.Instance.NewGuid();
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwBlockedMessageTypeRepository VwBlockedMessageTypeRepository
		=> vwBlockedMessageType ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwBlockedMessageTypeRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwMessageRepository VwMessageRepository
		=> vwMessage ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwMessageRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwMessageArchiveRepository VwMessageArchiveRepository
		=> vwMessageArchive ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwMessageArchiveRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwMessageContentRepository VwMessageContentRepository
		=> vwMessageContent ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwMessageContentRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwMessageProcessingLogRepository VwMessageProcessingLogRepository
		=> vwMessageProcessingLog ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwMessageProcessingLogRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwQueueRepository VwQueueRepository
		=> vwQueue ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwQueueRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwQueuedMessageRepository VwQueuedMessageRepository
		=> vwQueuedMessage ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwQueuedMessageRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwQueueMessagesRepository VwQueueMessagesRepository
		=> vwQueueMessages ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwQueueMessagesRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwSubscribedMessageRepository VwSubscribedMessageRepository
		=> vwSubscribedMessage ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwSubscribedMessageRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwTopicRepository VwTopicRepository
		=> vwTopic ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwTopicRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwTopicSubscriptionRepository VwTopicSubscriptionRepository
		=> vwTopicSubscription ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwTopicSubscriptionRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.MessageBox.Model.Repositories.IVwTopicSubscriptionMessagesRepository VwTopicSubscriptionMessagesRepository
		=> vwTopicSubscriptionMessages ??= new Legion.ADF.Messaging.MessageBox.SqlServer.Model.Repositories.VwTopicSubscriptionMessagesRepository(ConnectionProvider);
