...
{
	public static Inbox.Model.InboxMessageArchive? Map(
		Inbox.Model.InboxMessageArchive source,
		Inbox.Model.InboxMessageArchive? target,
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<Inbox.Model.InboxMessageArchive>>? conditions = null,
	...
	public Inbox.Model.InboxMessageArchive? Clone(
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<Inbox.Model.InboxMessageArchive>>? conditions = null,
		Legion.Reflection.InstanceFactory? instanceFactory = null,
		Dictionary<object, object>? cache = null)
	...
	public Inbox.Model.InboxMessageArchive? MapTo(
		Inbox.Model.InboxMessageArchive? target,
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<Inbox.Model.InboxMessageArchive>>? conditions = null,
		Legion.Reflection.InstanceFactory? instanceFactory = null,
	...
	{
		cache ??= [];
		target ??= instanceFactory?.CreateInstance<Legion.ADF.Messaging.Inbox.Model.InboxMessageArchive>(
				useActivatorIfNoFactoryFound: false,
				throwIfFactoryReturnsNull: true)
			?? new Legion.ADF.Messaging.Inbox.Model.InboxMessageArchive();

		if (cache.TryGetValue(this, out var cached))
			return (Inbox.Model.InboxMessageArchive)cached;
			
		MappingConditions<Inbox.Model.InboxMessageArchive>? conds = null;
		if (conditions != null)
		{
			conds = new MappingConditions<Inbox.Model.InboxMessageArchive>();
