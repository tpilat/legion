...
{
	public static IValidator<InboxMessageArchive> DefaultDBValidator { get; }
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Inbox.Model.InboxMessageType.MessageType | FK_InboxMessageArchive_IdMessageType
	/// </summary>
	public Guid IdMessageType { get; private set; }

	/// <summary>
	/// Database DataType: uuid NOT NULL | Inbox.Model.InboxMessageStatus.InboxMessageStatus | FK_InboxMessageArchive_IdInboxMessageStatus
	/// </summary>
	public Guid IdInboxMessageStatus { get; private set; }

	/// <summary>
	/// Database DataType: uuid NULL | Inbox.Model.InboxMessageContent.MessageContent | FK_InboxMessageArchive_IdMessageContent
	/// </summary>
	public Guid? IdMessageContent { get; private set; }

	/// <summary>
	/// Database DataType: uuid NOT NULL | Inbox.Model.InboxQueue.InboxQueue | FK_InboxMessageArchive_IdInboxQueue
	/// </summary>
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Inbox.Model.InboxInstance.InboxInstance | FK_InboxMessageArchive_IdInboxInstance
	/// </summary>
	public Guid IdInboxInstance { get; private set; }


	/// <summary>
	/// _1:N Guid IdInboxInstance | FK_InboxMessageArchive_IdInboxInstance
	/// </summary>
	public Inbox.Model.InboxInstance InboxInstance { get; private set; }

	/// <summary>
	/// _1:N Guid IdInboxMessageStatus | FK_InboxMessageArchive_IdInboxMessageStatus
	/// </summary>
	public Inbox.Model.InboxMessageStatus InboxMessageStatus { get; private set; }

	/// <summary>
	/// _1:N Guid IdInboxQueue | FK_InboxMessageArchive_IdInboxQueue
	/// </summary>
	public Inbox.Model.InboxQueue InboxQueue { get; private set; }

	/// <summary>
	/// UNIQUE INDEX: UQ_InboxMessageArchive_IdMessageContent
	/// _1:1 Guid? IdMessageContent | FK_InboxMessageArchive_IdMessageContent
	/// </summary>
	public Inbox.Model.InboxMessageContent MessageContent { get; private set; }

	/// <summary>
	/// _1:N Guid IdMessageType | FK_InboxMessageArchive_IdMessageType
	/// </summary>
	public Inbox.Model.InboxMessageType MessageType { get; private set; }

	private InboxMessageArchive()
	{
	}

	static InboxMessageArchive()
	{
		DefaultDBValidator = SetDBValidatorRules(new ValidatorBuilder<InboxMessageArchive>()).Build();
	}
	...
	public static ValidatorBuilder<InboxMessageArchive> SetDBValidatorRules(ValidatorBuilder<InboxMessageArchive> builder)
		=> builder
