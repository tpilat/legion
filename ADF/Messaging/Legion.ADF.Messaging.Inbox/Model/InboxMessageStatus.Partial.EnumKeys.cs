...
public partial class InboxMessageStatus : Inbox.InboxBaseEntity, Legion.Model.IEntity
{
	/// <summary>
	...
	static InboxMessageStatus()
	{
		...
		DefaultDBValidator = SetDBValidatorRules(new Legion.Validation.ValidatorBuilder<InboxMessageStatus>()).Build();
	}
