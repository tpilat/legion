...
public sealed partial class InboxMessageArchive : Inbox.InboxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Inbox.Model.InboxMessageArchive? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Inbox.Model.InboxMessageArchive>>? conditions = null)
		=> InboxMessageArchiveEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class InboxMessageArchiveEqualityComparer : IEqualityComparer<InboxMessageArchive>
	{
		public static bool EqualsTo(
			Inbox.Model.InboxMessageArchive? obj1,
			Inbox.Model.InboxMessageArchive? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Inbox.Model.InboxMessageArchive>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Inbox.Model.InboxMessageArchive>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Inbox.Model.InboxMessageArchive>();
		...
		public Action<ComparisonConditions<Inbox.Model.InboxMessageArchive>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public InboxMessageArchiveEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Inbox.Model.InboxMessageArchive>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Inbox.Model.InboxMessageArchive? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
