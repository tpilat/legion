...
public sealed partial class InboxMessageContent : Inbox.InboxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Inbox.Model.InboxMessageContent? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Inbox.Model.InboxMessageContent>>? conditions = null)
		=> InboxMessageContentEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class InboxMessageContentEqualityComparer : IEqualityComparer<InboxMessageContent>
	{
		public static bool EqualsTo(
			Inbox.Model.InboxMessageContent? obj1,
			Inbox.Model.InboxMessageContent? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Inbox.Model.InboxMessageContent>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Inbox.Model.InboxMessageContent>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Inbox.Model.InboxMessageContent>();
					conditions.Invoke(conds);

					if (conds.CanCompare(obj1, nameof(obj1.IdInboxMessageContent)) && obj1.IdInboxMessageContent != obj2.IdInboxMessageContent)
						return false;
				...
				{
					if (obj1.IdInboxMessageContent != obj2.IdInboxMessageContent)
						return false;
			...
			{
				if (!InboxMessage.InboxMessageEqualityComparer.EqualsTo(obj1.InboxMessage, obj2.InboxMessage, comparisonOptions, conds?.GetConditions(x => x.InboxMessage), cache))
					return false;
				if (!InboxMessageArchive.InboxMessageArchiveEqualityComparer.EqualsTo(obj1.InboxMessageArchive, obj2.InboxMessageArchive, comparisonOptions, conds?.GetConditions(x => x.InboxMessageArchive), cache))
					return false;
		}
		...
		public Action<ComparisonConditions<Inbox.Model.InboxMessageContent>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public InboxMessageContentEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Inbox.Model.InboxMessageContent>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Inbox.Model.InboxMessageContent? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
