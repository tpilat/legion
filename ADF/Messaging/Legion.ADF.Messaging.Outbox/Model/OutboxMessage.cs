...
{
	public static IValidator<OutboxMessage> DefaultDBValidator { get; }
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Outbox.Model.OutboxMessageType.MessageType | FK_OutboxMessage_IdMessageType
	/// </summary>
	public Guid IdMessageType { get; private set; }

	/// <summary>
	/// Database DataType: uuid NOT NULL | Outbox.Model.OutboxMessageStatus.OutboxMessageStatus | FK_OutboxMessage_IdOutboxMessageStatus
	/// </summary>
	public Guid IdOutboxMessageStatus { get; private set; }

	/// <summary>
	/// Database DataType: uuid NULL | Outbox.Model.OutboxMessageContent.MessageContent | FK_OutboxMessage_IdMessageContent
	/// </summary>
	public Guid? IdMessageContent { get; private set; }

	/// <summary>
	/// Database DataType: uuid NOT NULL | Outbox.Model.OutboxQueue.OutboxQueue | FK_OutboxMessage_IdOutboxQueue
	/// </summary>
	...
	/// <summary>
	/// Database DataType: uuid NOT NULL | Outbox.Model.OutboxInstance.OutboxInstance | FK_OutboxMessage_IdOutboxInstance
	/// </summary>
	public Guid IdOutboxInstance { get; private set; }


	/// <summary>
	/// UNIQUE INDEX: UQ_OutboxMessage_IdMessageContent
	/// _1:1 Guid? IdMessageContent | FK_OutboxMessage_IdMessageContent
	/// </summary>
	public Outbox.Model.OutboxMessageContent MessageContent { get; private set; }

	/// <summary>
	/// _1:N Guid IdMessageType | FK_OutboxMessage_IdMessageType
	/// </summary>
	public Outbox.Model.OutboxMessageType MessageType { get; private set; }

	/// <summary>
	/// _1:N Guid IdOutboxInstance | FK_OutboxMessage_IdOutboxInstance
	/// </summary>
	public Outbox.Model.OutboxInstance OutboxInstance { get; private set; }

	/// <summary>
	/// _1:N Guid IdOutboxMessageStatus | FK_OutboxMessage_IdOutboxMessageStatus
	/// </summary>
	public Outbox.Model.OutboxMessageStatus OutboxMessageStatus { get; private set; }

	/// <summary>
	/// _1:N Guid IdOutboxQueue | FK_OutboxMessage_IdOutboxQueue
	/// </summary>
	...
	static OutboxMessage()
	{
		DefaultDBValidator = SetDBValidatorRules(new ValidatorBuilder<OutboxMessage>()).Build();
	}
	...
	public static ValidatorBuilder<OutboxMessage> SetDBValidatorRules(ValidatorBuilder<OutboxMessage> builder)
		=> builder
