...
public partial class OutboxMessageStatus : Outbox.OutboxBaseEntity, Legion.Model.IEntity
{
	/// <summary>
	...
	/// </summary>
	public static Guid UnknownType { get; }

	static OutboxMessageStatus()
	{
		...
		UnknownType = new Guid("00000008-0000-0000-0000-000000000000");

		DefaultDBValidator = SetDBValidatorRules(new Legion.Validation.ValidatorBuilder<OutboxMessageStatus>()).Build();
	}
