...
{
	public static Outbox.Model.OutboxMessageArchive? Map(
		Outbox.Model.OutboxMessageArchive source,
		Outbox.Model.OutboxMessageArchive? target,
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<Outbox.Model.OutboxMessageArchive>>? conditions = null,
	...
	public Outbox.Model.OutboxMessageArchive? Clone(
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<Outbox.Model.OutboxMessageArchive>>? conditions = null,
		Legion.Reflection.InstanceFactory? instanceFactory = null,
		Dictionary<object, object>? cache = null)
	...
	public Outbox.Model.OutboxMessageArchive? MapTo(
		Outbox.Model.OutboxMessageArchive? target,
		ReferenceModifier referenceModifier = ReferenceModifier.SkipAllReferences,
		Action<MappingConditions<Outbox.Model.OutboxMessageArchive>>? conditions = null,
		Legion.Reflection.InstanceFactory? instanceFactory = null,
	...
	{
		cache ??= [];
		target ??= instanceFactory?.CreateInstance<Legion.ADF.Messaging.Outbox.Model.OutboxMessageArchive>(
				useActivatorIfNoFactoryFound: false,
				throwIfFactoryReturnsNull: true)
			?? new Legion.ADF.Messaging.Outbox.Model.OutboxMessageArchive();

		if (cache.TryGetValue(this, out var cached))
			return (Outbox.Model.OutboxMessageArchive)cached;
			
		MappingConditions<Outbox.Model.OutboxMessageArchive>? conds = null;
		if (conditions != null)
		{
			conds = new MappingConditions<Outbox.Model.OutboxMessageArchive>();
