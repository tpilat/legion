...
public sealed partial class OutboxMessageArchive : Outbox.OutboxBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Outbox.Model.OutboxMessageArchive? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Outbox.Model.OutboxMessageArchive>>? conditions = null)
		=> OutboxMessageArchiveEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class OutboxMessageArchiveEqualityComparer : IEqualityComparer<OutboxMessageArchive>
	{
		public static bool EqualsTo(
			Outbox.Model.OutboxMessageArchive? obj1,
			Outbox.Model.OutboxMessageArchive? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Outbox.Model.OutboxMessageArchive>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Outbox.Model.OutboxMessageArchive>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Outbox.Model.OutboxMessageArchive>();
		...
		public Action<ComparisonConditions<Outbox.Model.OutboxMessageArchive>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public OutboxMessageArchiveEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Outbox.Model.OutboxMessageArchive>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Outbox.Model.OutboxMessageArchive? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
