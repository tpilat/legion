CREATE VIEW inbox."VwBlockedInboxMessageType"
AS
SELECT
...
CREATE VIEW mbox."VwBlockedMessageType"
AS
SELECT
...
CREATE VIEW outbox."VwBlockedOutboxMessageType"
AS
SELECT
...
CREATE VIEW devt."VwDomainEvent"
AS
SELECT
	*
FROM devt."DomainEvent";

CREATE VIEW inbox."VwInboxMessage"
AS
SELECT
	im."IdInboxMessage",
	im."IdMessageType",
...
CREATE VIEW inbox."VwInboxMessageArchive"
AS
SELECT
	ima."IdInboxMessage",
	ima."IdMessageType",
...
CREATE VIEW inbox."VwInboxMessageContent"
AS
SELECT
...
CREATE VIEW inbox."VwInboxMessageProcessingLog"
AS
SELECT
...
CREATE VIEW inbox."VwInboxQueue"
AS
SELECT
	iq."IdInboxQueue",
	iq."Name",
...
CREATE VIEW inbox."VwInboxQueueMessages"
AS
SELECT
	iq."IdInboxQueue",
	...
	iq."IsSequentialFIFO",
	iq."MaxDegreeOfParallelism",
	COALESCE(created."MessageCount", 0) AS "CreatedMessageCount",
	COALESCE(processing."MessageCount", 0) AS "ProcessingMessageCount",
	COALESCE(processed."MessageCount", 0) AS "ProcessedMessageCount",
	COALESCE(failed."MessageCount", 0) AS "FailedMessageCount",
	COALESCE(suspended."MessageCount", 0) AS "SuspendedMessageCount"
FROM inbox."InboxQueue" iq
LEFT JOIN (
	SELECT
		im."IdInboxQueue",
...
CREATE VIEW mbox."VwMessageArchive"
AS
SELECT
	ma."IdMessage",
	ma."IdMessageType",
...
CREATE VIEW mbox."VwMessageContent"
AS
SELECT
	mc."IdMessageContent",
	mc."MimeType",
...
CREATE VIEW mbox."VwMessageProcessingLog"
AS
SELECT
...
CREATE VIEW outbox."VwOutboxMessage"
AS
SELECT
	om."IdOutboxMessage",
	om."IdMessageType",
...
CREATE VIEW outbox."VwOutboxMessageArchive"
AS
SELECT
	oma."IdOutboxMessage",
	oma."IdMessageType",
...
CREATE VIEW outbox."VwOutboxMessageContent"
AS
SELECT
...
CREATE VIEW outbox."VwOutboxMessageProcessingLog"
AS
SELECT
...
CREATE VIEW outbox."VwOutboxQueue"
AS
SELECT
	oq."IdOutboxQueue",
	oq."Name",
...
CREATE VIEW outbox."VwOutboxQueueMessages"
AS
SELECT
	oq."IdOutboxQueue",
...
CREATE VIEW mbox."VwQueueMessages"
AS
SELECT
	q."IdQueue",
	q."Name" AS "QueueName",
	...
	q."IdJob",
	q."IdOrchestration",
	COALESCE(assigned."MessageCount", 0) AS "AssignedMessageCount",
	COALESCE(processing."MessageCount", 0) AS "ProcessingMessageCount",
	COALESCE(processed."MessageCount", 0) AS "ProcessedMessageCount",
	COALESCE(failed."MessageCount", 0) AS "FailedMessageCount",
	COALESCE(suspended."MessageCount", 0) AS "SuspendedMessageCount"
...
CREATE VIEW mbox."VwSubscribedMessage"
AS
SELECT
...
CREATE VIEW mbox."VwTopicSubscription"
AS
SELECT
...
CREATE VIEW mbox."VwTopicSubscriptionMessages"
AS
SELECT
	ts."IdTopicSubscription",
	ts."SubscriptionName",
