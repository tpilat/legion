...
public class GetAllOutboxQueuesQueryHandler : AsyncMessageHandlerBase<Legion.ADF.Messaging.Outbox.Queries.OutboxQueue.GetAllOutboxQueuesQuery, System.Collections.Generic.List<Legion.ADF.Messaging.Outbox.Model.OutboxQueue>>
{
	public override async Task<IResult<System.Collections.Generic.List<Legion.ADF.Messaging.Outbox.Model.OutboxQueue>>> HandleAsync(
		...
		Legion.ADF.Messaging.Outbox.Queries.OutboxQueue.GetAllOutboxQueuesQuery query,
		...
		CancellationToken cancellationToken = default)
	{
		...
		var data = await uow.OutboxQueueRepository.GetAllOutboxQueues(query with { AsNoTracking = true })
