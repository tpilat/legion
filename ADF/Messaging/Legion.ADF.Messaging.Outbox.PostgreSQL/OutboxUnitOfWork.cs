...
internal partial class OutboxUnitOfWork : Legion.ADF.Messaging.Outbox.IOutboxUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	...
	{
#if TRACK_OBJECTS
		IdOutboxUnitOfWork = Legion.GlobalContext.Instance.NewGuid();
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IBlockedOutboxMessageTypeRepository BlockedOutboxMessageTypeRepository
		=> blockedOutboxMessageType ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.BlockedOutboxMessageTypeRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxInstanceRepository OutboxInstanceRepository
		=> outboxInstance ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxInstanceRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxMessageRepository OutboxMessageRepository
		=> outboxMessage ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxMessageRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxMessageArchiveRepository OutboxMessageArchiveRepository
		=> outboxMessageArchive ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxMessageArchiveRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxMessageContentRepository OutboxMessageContentRepository
		=> outboxMessageContent ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxMessageContentRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxMessageProcessingLogRepository OutboxMessageProcessingLogRepository
		=> outboxMessageProcessingLog ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxMessageProcessingLogRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxMessageStatusRepository OutboxMessageStatusRepository
		=> outboxMessageStatus ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxMessageStatusRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxMessageTypeRepository OutboxMessageTypeRepository
		=> outboxMessageType ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxMessageTypeRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxProcessingLogRepository OutboxProcessingLogRepository
		=> outboxProcessingLog ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxProcessingLogRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxQueueRepository OutboxQueueRepository
		=> outboxQueue ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxQueueRepository(ConnectionProvider);
	...
	public Legion.ADF.Messaging.Outbox.Model.Repositories.IOutboxQueueProcessingModeRepository OutboxQueueProcessingModeRepository
		=> outboxQueueProcessingMode ??= new Legion.ADF.Messaging.Outbox.PostgreSQL.Model.Repositories.OutboxQueueProcessingModeRepository(ConnectionProvider);
