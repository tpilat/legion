...
public partial class VwBlockedOutboxMessageTypeRepository : Legion.ADF.Messaging.Outbox.PostgreSQL.OutboxQueryRepositoryBase, Legion.ADF.Messaging.Outbox.IOutboxQueryRepository<Legion.ADF.Messaging.Outbox.Model.VwBlockedOutboxMessageType>, Legion.ADF.Messaging.Outbox.Model.Repositories.IVwBlockedOutboxMessageTypeRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.Outbox.PostgreSQL.IOutboxQueryDbContext>(scopeContext)).VwBlockedOutboxMessageType;
