...
public partial class VwOutboxQueueRepository : Legion.ADF.Messaging.Outbox.PostgreSQL.OutboxQueryRepositoryBase, Legion.ADF.Messaging.Outbox.IOutboxQueryRepository<Legion.ADF.Messaging.Outbox.Model.VwOutboxQueue>, Legion.ADF.Messaging.Outbox.Model.Repositories.IVwOutboxQueueRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.Outbox.PostgreSQL.IOutboxQueryDbContext>(scopeContext)).VwOutboxQueue;
