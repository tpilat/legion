...
public partial class DomainEventProcessingStatusRepository : Legion.ADF.Messaging.DomainEvents.PostgreSQL.DomainEventsRepositoryBase, Legion.ADF.Messaging.DomainEvents.IDomainEventsRepository<Legion.ADF.Messaging.DomainEvents.Model.DomainEventProcessingStatus>, Legion.ADF.Messaging.DomainEvents.Model.Repositories.IDomainEventProcessingStatusRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.DomainEvents.PostgreSQL.IDomainEventsDbContext>(scopeContext)).DomainEventProcessingStatus;
