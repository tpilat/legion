...
public partial class BlockedDomainEventTypeRepository : Legion.ADF.Messaging.DomainEvents.PostgreSQL.DomainEventsRepositoryBase, Legion.ADF.Messaging.DomainEvents.IDomainEventsRepository<Legion.ADF.Messaging.DomainEvents.Model.BlockedDomainEventType>, Legion.ADF.Messaging.DomainEvents.Model.Repositories.IBlockedDomainEventTypeRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.DomainEvents.PostgreSQL.IDomainEventsDbContext>(scopeContext)).BlockedDomainEventType;
