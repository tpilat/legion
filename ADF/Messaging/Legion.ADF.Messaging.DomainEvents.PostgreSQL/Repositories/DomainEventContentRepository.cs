...
public partial class DomainEventContentRepository : Legion.ADF.Messaging.DomainEvents.PostgreSQL.DomainEventsRepositoryBase, Legion.ADF.Messaging.DomainEvents.IDomainEventsRepository<Legion.ADF.Messaging.DomainEvents.Model.DomainEventContent>, Legion.ADF.Messaging.DomainEvents.Model.Repositories.IDomainEventContentRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.DomainEvents.PostgreSQL.IDomainEventsDbContext>(scopeContext)).DomainEventContent;
