...
{
	public const string PREFIX = "ADFMessaging";
...
public static class AppSettingsExtensions
{
	public static IServiceCollection AddAppSettings(this IServiceCollection services)
	{
		...
		services.AddMessagingDomainEventsStoreOptions();
		services.AddMessagingInboxStoreOptions();
		services.AddMessagingOutboxStoreOptions();
		services.AddDomainEventProcessingServiceOptions();
		services.AddInboxMessageProcessingServiceOptions();
		services.AddOutboxMessageProcessingServiceOptions();
