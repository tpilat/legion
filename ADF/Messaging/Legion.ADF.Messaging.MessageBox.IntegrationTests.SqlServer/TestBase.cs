...
public abstract class TestBase
{
	...
	{
		SetUp.ClearScopedServiceProvider();
	...
	protected IMessageBoxUnitOfWork CreateMessageBoxUnitOfWork(IScopeContext scopeContext, IServiceProvider serviceProvider)
	{
		...
		var uowFactory = serviceProvider.GetRequiredService<IMessageBoxUnitOfWorkFactory>();
