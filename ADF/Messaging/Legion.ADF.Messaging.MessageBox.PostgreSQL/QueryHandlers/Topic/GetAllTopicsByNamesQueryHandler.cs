...
public class GetAllTopicsByNamesQueryHandler : AsyncMessageHandlerBase<Legion.ADF.Messaging.MessageBox.Queries.Topic.GetAllTopicsByNamesQuery, System.Collections.Generic.List<Legion.ADF.Messaging.MessageBox.Model.Topic>>
{
	public override async Task<IResult<System.Collections.Generic.List<Legion.ADF.Messaging.MessageBox.Model.Topic>>> HandleAsync(
		...
		Legion.ADF.Messaging.MessageBox.Queries.Topic.GetAllTopicsByNamesQuery query,
		...
		CancellationToken cancellationToken = default)
	{
		...
		var data = await uow.TopicRepository.GetAllTopicsByNames(query with { AsNoTracking = true })
