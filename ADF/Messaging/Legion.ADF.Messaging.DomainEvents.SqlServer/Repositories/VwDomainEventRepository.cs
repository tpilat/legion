...
public partial class VwDomainEventRepository : Legion.ADF.Messaging.DomainEvents.SqlServer.DomainEventsQueryRepositoryBase, Legion.ADF.Messaging.DomainEvents.IDomainEventsQueryRepository<Legion.ADF.Messaging.DomainEvents.Model.VwDomainEvent>, Legion.ADF.Messaging.DomainEvents.Model.Repositories.IVwDomainEventRepository
{
	...
	private Legion.ADF.Messaging.DomainEvents.SqlServer.IDomainEventsQueryDbContext? _context;
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.DomainEvents.SqlServer.IDomainEventsQueryDbContext>(scopeContext)).VwDomainEvent;
