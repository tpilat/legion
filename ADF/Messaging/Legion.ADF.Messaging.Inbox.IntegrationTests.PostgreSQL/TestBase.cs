...
public abstract class TestBase
{
	...
	protected IInboxUnitOfWork CreateInboxUnitOfWork(IScopeContext scopeContext, IServiceProvider serviceProvider)
	{
		...
		var uowFactory = serviceProvider.GetRequiredService<IInboxUnitOfWorkFactory>();
