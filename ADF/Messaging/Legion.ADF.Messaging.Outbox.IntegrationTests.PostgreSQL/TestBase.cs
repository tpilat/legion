...
public abstract class TestBase
{
	...
	protected IOutboxUnitOfWork CreateOutboxUnitOfWork(IScopeContext scopeContext, IServiceProvider serviceProvider)
	{
		...
		var uowFactory = serviceProvider.GetRequiredService<IOutboxUnitOfWorkFactory>();
