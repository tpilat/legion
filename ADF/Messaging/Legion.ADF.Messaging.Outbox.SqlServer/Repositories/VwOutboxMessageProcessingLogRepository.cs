...
public partial class VwOutboxMessageProcessingLogRepository : Legion.ADF.Messaging.Outbox.SqlServer.OutboxQueryRepositoryBase, Legion.ADF.Messaging.Outbox.IOutboxQueryRepository<Legion.ADF.Messaging.Outbox.Model.VwOutboxMessageProcessingLog>, Legion.ADF.Messaging.Outbox.Model.Repositories.IVwOutboxMessageProcessingLogRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.Outbox.SqlServer.IOutboxQueryDbContext>(scopeContext)).VwOutboxMessageProcessingLog;
