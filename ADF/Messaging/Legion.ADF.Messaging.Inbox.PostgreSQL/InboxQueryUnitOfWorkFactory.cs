...
public partial class InboxQueryUnitOfWorkFactory : IInboxQueryUnitOfWorkFactory
{
	public IInboxQueryUnitOfWork Create(Legion.Database.IConnectionProvider connectionProvider)
	{
		...
		return new InboxQueryUnitOfWork(efConnectionProvider);
	}

	public IInboxQueryUnitOfWork Create(Legion.Model.Repositories.IUnitOfWork unitOfWork)
	{
		...
		return new InboxQueryUnitOfWork(dbUnitOfWork);
	}

	public IInboxQueryUnitOfWork Create(Legion.Model.Repositories.IQueryUnitOfWork queryUnitOfWork)
	{
		...
		return new InboxQueryUnitOfWork(dbQueryUnitOfWork);
	}

	public IInboxQueryUnitOfWork Create(
		IServiceProvider serviceProvider,
		string connectionStirng,
		System.Data.IsolationLevel? isolationLevel,
		bool? allowLocking,
		bool createAuditEntryStore)
		=> new InboxQueryUnitOfWork(
			serviceProvider,
			connectionStirng,
			isolationLevel,
			allowLocking,
	...
	public IInboxQueryUnitOfWork CreateWithoutTransaction(
		IServiceProvider serviceProvider,
		string connectionStirng,
		bool? allowLocking,
		bool createAuditEntryStore)
