...
public partial class VwInboxQueueRepository : Legion.ADF.Messaging.Inbox.PostgreSQL.InboxQueryRepositoryBase, Legion.ADF.Messaging.Inbox.IInboxQueryRepository<Legion.ADF.Messaging.Inbox.Model.VwInboxQueue>, Legion.ADF.Messaging.Inbox.Model.Repositories.IVwInboxQueueRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Messaging.Inbox.PostgreSQL.IInboxQueryDbContext>(scopeContext)).VwInboxQueue;
