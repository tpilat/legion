...
public class GetBlockedInboxMessageTypesByNamespaces :
	QueryDefinition<
		IInboxDbContext,
		Inbox.Model.BlockedInboxMessageType,
		List<Inbox.Model.BlockedInboxMessageType>,
		GetBlockedInboxMessageTypesByNamespacesQuery>,
		IGetBlockedInboxMessageTypesByNamespaces
{
	public GetBlockedInboxMessageTypesByNamespaces(
		IEFConnectionProvider connectionProvider,
		GetBlockedInboxMessageTypesByNamespacesQuery GetBlockedInboxMessageTypesByNamespaces)
		: base(connectionProvider, GetBlockedInboxMessageTypesByNamespaces)
	{
	}
