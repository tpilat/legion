...
public abstract class TestBase
{
	...
	protected IAuditUnitOfWork CreateAuditUnitOfWork(IScopeContext scopeContext, IServiceProvider serviceProvider)
	{
		...
		var uowFactory = serviceProvider.GetRequiredService<IAuditUnitOfWorkFactory>();
