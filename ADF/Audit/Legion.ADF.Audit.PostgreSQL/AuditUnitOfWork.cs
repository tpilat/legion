...
internal partial class AuditUnitOfWork : Legion.ADF.Audit.IAuditUnitOfWork, Legion.EntityFrameworkCore.Model.Repositories.IDbUnitOfWork, Legion.Model.Repositories.IUnitOfWork, IDisposable, IAsyncDisposable
{
	private bool _isInternalConnectionProvider;
	private bool _disposed;

#if TRACK_OBJECTS
	public Guid IdAuditUnitOfWork { get; }
#endif
	...
	private Legion.ADF.Audit.Model.Repositories.IApplicationEntryRepository? applicationEntry;
	public Legion.ADF.Audit.Model.Repositories.IApplicationEntryRepository ApplicationEntryRepository
		=> applicationEntry ??= new Legion.ADF.Audit.PostgreSQL.Model.Repositories.ApplicationEntryRepository(ConnectionProvider);


	private Legion.ADF.Audit.Model.Repositories.IApplicationEntryRequestRepository? applicationEntryRequest;
	public Legion.ADF.Audit.Model.Repositories.IApplicationEntryRequestRepository ApplicationEntryRequestRepository
		=> applicationEntryRequest ??= new Legion.ADF.Audit.PostgreSQL.Model.Repositories.ApplicationEntryRequestRepository(ConnectionProvider);


	private Legion.ADF.Audit.Model.Repositories.IApplicationEntryResponseRepository? applicationEntryResponse;
	public Legion.ADF.Audit.Model.Repositories.IApplicationEntryResponseRepository ApplicationEntryResponseRepository
		=> applicationEntryResponse ??= new Legion.ADF.Audit.PostgreSQL.Model.Repositories.ApplicationEntryResponseRepository(ConnectionProvider);


	private Legion.ADF.Audit.Model.Repositories.IApplicationEntryTokenRepository? applicationEntryToken;
	public Legion.ADF.Audit.Model.Repositories.IApplicationEntryTokenRepository ApplicationEntryTokenRepository
		=> applicationEntryToken ??= new Legion.ADF.Audit.PostgreSQL.Model.Repositories.ApplicationEntryTokenRepository(ConnectionProvider);


	private Legion.ADF.Audit.Model.Repositories.IAuditEntryRepository? auditEntry;
	public Legion.ADF.Audit.Model.Repositories.IAuditEntryRepository AuditEntryRepository
		=> auditEntry ??= new Legion.ADF.Audit.PostgreSQL.Model.Repositories.AuditEntryRepository(ConnectionProvider);


	private Legion.ADF.Audit.Model.Repositories.IAuditOperationRepository? auditOperation;
	public Legion.ADF.Audit.Model.Repositories.IAuditOperationRepository AuditOperationRepository
		=> auditOperation ??= new Legion.ADF.Audit.PostgreSQL.Model.Repositories.AuditOperationRepository(ConnectionProvider);
	...
	{
#if TRACK_OBJECTS
		Trackers.ObjectLifetimeTracker.SetDisposed(this, IdAuditUnitOfWork.ToString());
#endif
