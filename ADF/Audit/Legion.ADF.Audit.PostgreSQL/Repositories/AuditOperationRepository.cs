...
public partial class AuditOperationRepository : Legion.ADF.Audit.PostgreSQL.AuditRepositoryBase, Legion.ADF.Audit.IAuditRepository<Legion.ADF.Audit.Model.AuditOperation>, Legion.ADF.Audit.Model.Repositories.IAuditOperationRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Audit.PostgreSQL.IAuditDbContext>(scopeContext)).AuditOperation;
