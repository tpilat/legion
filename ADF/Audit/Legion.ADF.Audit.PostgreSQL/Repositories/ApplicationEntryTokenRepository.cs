...
public partial class ApplicationEntryTokenRepository : Legion.ADF.Audit.PostgreSQL.AuditRepositoryBase, Legion.ADF.Audit.IAuditRepository<Legion.ADF.Audit.Model.ApplicationEntryToken>, Legion.ADF.Audit.Model.Repositories.IApplicationEntryTokenRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Audit.PostgreSQL.IAuditDbContext>(scopeContext)).ApplicationEntryToken;
