...
public partial class ApplicationEntryResponseRepository : Legion.ADF.Audit.PostgreSQL.AuditRepositoryBase, Legion.ADF.Audit.IAuditRepository<Legion.ADF.Audit.Model.ApplicationEntryResponse>, Legion.ADF.Audit.Model.Repositories.IApplicationEntryResponseRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Audit.PostgreSQL.IAuditDbContext>(scopeContext)).ApplicationEntryResponse;
