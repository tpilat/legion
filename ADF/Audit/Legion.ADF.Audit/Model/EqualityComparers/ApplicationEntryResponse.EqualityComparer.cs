...
public sealed partial class ApplicationEntryResponse : Audit.AuditBaseEntity, Legion.Model.IEntity
{
	public bool EqualsTo(
		Audit.Model.ApplicationEntryResponse? obj,
		ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
		Action<ComparisonConditions<Audit.Model.ApplicationEntryResponse>>? conditions = null)
		=> ApplicationEntryResponseEqualityComparer.EqualsTo(
			this,
			obj,
			comparisonOptions,
			conditions,
	...
	public sealed partial class ApplicationEntryResponseEqualityComparer : IEqualityComparer<ApplicationEntryResponse>
	{
		public static bool EqualsTo(
			Audit.Model.ApplicationEntryResponse? obj1,
			Audit.Model.ApplicationEntryResponse? obj2,
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Audit.Model.ApplicationEntryResponse>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
			...
			ComparisonConditions<Audit.Model.ApplicationEntryResponse>? conds = null;
		
			if ((ComparisonOptions.CompareProperties & comparisonOptions) == ComparisonOptions.CompareProperties)
			{
				if (conditions != null)
				{
					conds = new ComparisonConditions<Audit.Model.ApplicationEntryResponse>();
					conditions.Invoke(conds);

					if (conds.CanCompare(obj1, nameof(obj1.IdApplicationEntryResponse)) && obj1.IdApplicationEntryResponse != obj2.IdApplicationEntryResponse)
						return false;
				...
				{
					if (obj1.IdApplicationEntryResponse != obj2.IdApplicationEntryResponse)
						return false;
			...
			{
				if (!ApplicationEntry.ApplicationEntryEqualityComparer.EqualsTo(obj1.ApplicationEntry, obj2.ApplicationEntry, comparisonOptions, conds?.GetConditions(x => x.ApplicationEntry), cache))
					return false;
		}
		...
		public Action<ComparisonConditions<Audit.Model.ApplicationEntryResponse>>? Conditions { get; }
		public Dictionary<object, HashSet<object>>? Cache { get; }
	
		public ApplicationEntryResponseEqualityComparer(
			ComparisonOptions comparisonOptions = ComparisonOptions.CompareAll,
			Action<ComparisonConditions<Audit.Model.ApplicationEntryResponse>>? conditions = null,
			Dictionary<object, HashSet<object>>? cache = null)
		{
		...
		public int GetHashCode([DisallowNull] Audit.Model.ApplicationEntryResponse? obj)
			=> GetHashCode(
				obj,
				ComparisonOptions,
				Conditions,
