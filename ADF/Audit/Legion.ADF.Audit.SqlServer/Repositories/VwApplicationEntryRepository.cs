...
public partial class VwApplicationEntryRepository : Legion.ADF.Audit.SqlServer.AuditQueryRepositoryBase, Legion.ADF.Audit.IAuditQueryRepository<Legion.ADF.Audit.Model.VwApplicationEntry>, Legion.ADF.Audit.Model.Repositories.IVwApplicationEntryRepository
{
	...
	{
		var queryable = (_context ??= ConnectionProvider.GetOrCreateDbContext<Legion.ADF.Audit.SqlServer.IAuditQueryDbContext>(scopeContext)).VwApplicationEntry;
