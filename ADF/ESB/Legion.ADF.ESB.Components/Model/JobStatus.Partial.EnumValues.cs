...
public partial class JobStatus : Components.ComponentsBaseEntity, Legion.Model.IEntity, IComparable
{
	/// <summary>
	...
	/// </summary>
	public static JobStatus Offline_NewObject => new(new Guid("00000002-0000-0000-0000-000000000000"), "Offline", "Offline");

	/// <summary>
	/// 00000003-0000-0000-0000-000000000000
	/// </summary>
	public static JobStatus Running_NewObject => new(new Guid("00000003-0000-0000-0000-000000000000"), "Running", "Running");

	/// <summary>
	/// 00000004-0000-0000-0000-000000000000
	/// </summary>
	public static JobStatus Idle_NewObject => new(new Guid("00000004-0000-0000-0000-000000000000"), "Idle", "Idle");
	...
	public static readonly Lazy<IReadOnlyDictionary<Guid, JobStatus>> DictionaryMap = new(() => new Dictionary<Guid, JobStatus>
	{
			...
			{ new Guid("00000004-0000-0000-0000-000000000000"), Idle_NewObject },
