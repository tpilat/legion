...
public class SocPoistOrchestration_Start : ESBOrchestrationStep,
	IEventSubscriber<SocPoistOrchestrationStart>
{
	public SocPoistOrchestration_Start()
	{
		IdOrchestrationStep = Guid.NewGuid();
		IsMainEntry = true;
		Code = "SocPoistOrchestration_Start";
		Name = "SocPoistOrchestration_Start";
		Description = "SocPoistOrchestration_Start";
		Properties = null;
		Order = 1;
	}

	public override ESBOrchestrationStep Default()
		=> new SocPoistOrchestration_Start();
